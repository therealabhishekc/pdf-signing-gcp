...
export declare function expectSingleLinkCallAndClear<T extends ObjectTypeDefinition>(subFn: MockedObject<Observer<SpecificLinkPayload | undefined>>, resolvedList: ObjectHolder[] | Osdk.Instance<T>[] | undefined, payloadOptions?: Omit<Partial<SpecificLinkPayload>, "resolvedList">): SpecificLinkPayload | undefined;
export declare function expectSingleListCallAndClear<T extends ObjectTypeDefinition>(subFn: MockedObject<Observer<ListPayload | undefined>>, resolvedList: ObjectHolder[] | Osdk.Instance<T>[], payloadOptions?: Omit<Partial<ListPayload>, "resolvedList">): ListPayload | undefined;
/**
* Validates object payload emissions in tests
*/
export declare function expectSingleObjectCallAndClear<T extends ObjectTypeDefinition>(subFn: MockedObject<Observer<ObjectPayload | undefined>>, object: Osdk.Instance<T> | undefined, status?: Status): ObjectPayload | undefined;
...
export type MockedSingleSubCallback = MockedObject<Observer<ObjectPayload | undefined>> & {
	expectLoadingAndLoaded: (q: {
		loading?: unknown
		loaded: unknown
	}) => Promise<void>
};
export declare function mockSingleSubCallback(): MockedSingleSubCallback;
...
export declare function mockLinkSubCallback(): MockedObject<Observer<SpecificLinkPayload | undefined>>;
...
export declare function linkPayloadContaining(x: Partial<SpecificLinkPayload>): SpecificLinkPayload;
