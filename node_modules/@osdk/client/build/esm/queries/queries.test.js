...
import { $Queries, acceptsThreeDimensionalAggregationFunction, acceptsTwoDimensionalAggregationFunction, addOne, Employee, FooInterface, incrementPersonAge, incrementPersonAgeComplex, queryAcceptsInterface, queryAcceptsInterfaceObjectSet, queryAcceptsObject, queryAcceptsObjectSets, queryTypeReturnsArrayOfObjects, queryTypeReturnsMap, returnsDate, returnsTimestamp, threeDimensionalAggregationFunction, twoDimensionalAggregationFunction } from "@osdk/client.test.ontology";
...
describe("queries", () => {
  ...
  describe("Queries that accept objects work do not break", () => {
    ...
    it("Works when passing in interface object sets", async () => {
      ...
      const result = await client(queryAcceptsInterfaceObjectSet).executeFunction({
  ...
  it("queries are enumerable", async () => {
    ...
    expect(queries).toStrictEqual(["acceptsThreeDimensionalAggregationFunction", "acceptsTwoDimensionalAggregationFunction", "addOne", "incrementPersonAge", "incrementPersonAgeComplex", "queryAcceptsInterface", "queryAcceptsInterfaceObjectSet", "queryAcceptsObject", "queryAcceptsObjectSets", "queryOutputsInterface", "queryTypeReturnsArray", "queryTypeReturnsArrayOfObjects", "queryTypeReturnsMap", "returnsDate", "returnsObject", "returnsTimestamp", "threeDimensionalAggregationFunction", "twoDimensionalAggregationFunction"]);
  });
