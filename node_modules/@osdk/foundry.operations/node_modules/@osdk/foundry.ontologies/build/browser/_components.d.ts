 ...
 * Log Safety: SAFE
 */
export type InterfacePropertyTypeRid = LooselyBrandedString<"InterfacePropertyTypeRid">;
/**
 ...
 * Log Safety: UNSAFE
 */
export type InterfaceToObjectTypeMappingsV2 = Record<ObjectTypeApiName, InterfaceToObjectTypeMappingV2>;
/**
 * Represents an implementation of an interface (the mapping of interface property to how it is implemented.
 *
 * Log Safety: UNSAFE
 */
export type InterfaceToObjectTypeMappingV2 = Record<InterfacePropertyApiName, InterfacePropertyTypeImplementation>;
/**
...
export interface InterfaceType {
    ...
    allPropertiesV2: Record<InterfacePropertyApiName, ResolvedInterfacePropertyType>;
 ...
 * Log Safety: SAFE
 */
export type OntologyTransactionId = LooselyBrandedString<"OntologyTransactionId">;
/**
 * Metadata about an Ontology.
 *
 * Log Safety: UNSAFE
...
Examples: 'myGroup:myFunction:latest', 'myGroup:myFunction:1.0.0', 'myFunction', 'myFunction:2.0.0'
   ...
   * Log Safety: UNSAFE
   */
export type VersionedQueryTypeApiName = LooselyBrandedString<"VersionedQueryTypeApiName">;
/**
