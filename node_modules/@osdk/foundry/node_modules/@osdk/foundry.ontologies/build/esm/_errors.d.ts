...
export interface AggregationMetricNotSupported {
    ...
    errorDescription: "The requested aggregation metric is not supported by the storage backend. Consider migrating queried object types to Object Storage V2. See https://www.palantir.com/docs/foundry/object-backend/osv1-osv2-migration for more details.";
    errorInstanceId: string;
    parameters: {
        metricType: unknown;
    };
...
export interface AttachmentRidAlreadyExists {
    ...
    errorDescription: "The provided attachment RID already exists and cannot be overwritten.";
    errorInstanceId: string;
    parameters: {
        attachmentRid: unknown;
    };
...
export interface ConsistentSnapshotError {
    ...
    errorDescription: "An Ontology objects read failed because the Ontology snapshot snapshot used for consistent reads became stale. Retrying the request typically resolves this.";
    errorInstanceId: string;
    parameters: {};
}
/**
...
export interface IncompatibleNestedObjectSet {
    ...
    errorDescription: "A wrapper object set type is incompatible with one or more of the nested object set types. For example, an interfaceLinkSearchAround object set wrapping a non-interface object set.";
    errorInstanceId: string;
    parameters: {};
}
/**
...
export interface InterfaceBasedObjectSetNotSupported {
    ...
    errorDescription: "The requested object set type is not supported for interface-based object sets.";
    errorInstanceId: string;
    parameters: {};
}
/**
...
export interface InterfacePropertiesNotFound {
    ...
    errorDescription: "The requested interface property types are not present on every object type.";
    errorInstanceId: string;
    parameters: {
        objectType: unknown;
...
export interface InterfacePropertyNotFound {
    ...
    errorDescription: "The requested interface property was not found on the interface type.";
    errorInstanceId: string;
    parameters: {
...
export interface InvalidAggregationRangePropertyTypeForInterface {
    ...
    errorDescription: "Range group by is not supported by interface property type.";
    errorInstanceId: string;
    parameters: {
        interfaceProperty: unknown;
        interfaceType: unknown;
...
export interface InvalidTransactionEditPropertyValue {
    ...
    errorDescription: "The value of the given property is invalid. See the documentation of DataValue for details on how properties are represented for transaction edits.";
    errorInstanceId: string;
    parameters: {
...
export interface LoadObjectSetLinksNotSupported {
    ...
    errorDescription: "Bulk loading object set links is not supported by Object Storage v1.";
    errorInstanceId: string;
    parameters: {};
}
/**
...
export interface ObjectsModifiedConcurrently {
    ...
    errorDescription: "The provided objects are being modified concurrently and the operation would result in a conflict. The client should retry the request later.";
    errorInstanceId: string;
    parameters: {
        functionRid: unknown;
        functionVersion: unknown;
...
export interface SimilarityThresholdOutOfRange {
    ...
    errorDescription: "The value of the similarity threshold must be in the range 0 <= threshold <= 1.";
    errorInstanceId: string;
    parameters: {
...
export interface UniqueIdentifierLinkIdsDoNotExistInActionType {
    ...
    errorDescription: "One or more unique identifier link IDs specified in apply action overrides could not be found in the ActionType definition.";
    errorInstanceId: string;
    parameters: {
...
export interface UnsupportedInterfaceBasedObjectSet {
    ...
    errorDescription: "Aggregations on interface-based object sets are not supported for object sets with OSv1 objects.";
    errorInstanceId: string;
    parameters: {
        interfaceType: unknown;
    };
