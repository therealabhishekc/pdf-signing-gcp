...
export type AllowedFoundryNetworkPolicy = AllowedFoundryNetworkPolicy_destinationNamespaceConnectionPolicy;
...
*/
export type CancelDueToLackOfPollingConfig = CancelDueToLackOfPollingConfig_neverCancel | CancelDueToLackOfPollingConfig_cancelAfterDuration;
...
export type ComplexType = ComplexType_structType | ComplexType_listType | ComplexType_setType;
export interface ComputationParamsV1 {
	...
	expectedMaxResultSizeMb?: number | "NaN" | "Infinity" | "-Infinity" | null | undefined;
	...
	resourceConstraintsAndReportingOverrides?: ResourceConstraintsAndReportingOverrides | null | undefined;
...
export type ComputeModuleAuthMode = "NONE" | "BUILD" | "SECURE_BUILD" | "THIRD_PARTY" | "OUTBOUND" | "SCOPED_USER_TOKEN";
...
export type ComputeModuleInput = ComputeModuleInput_namedCredentialInput | ComputeModuleInput_fmlLiveInput | ComputeModuleInput_datasetInput | ComputeModuleInput_streamInput | ComputeModuleInput_mediaSetInput | ComputeModuleInput_modelInput;
...
export type ComputeModuleOutput = ComputeModuleOutput_datasetOutput | ComputeModuleOutput_streamOutput | ComputeModuleOutput_mediaSetOutput;
...
* document for now.
*/
export type ComputeModuleReservedEnvVars = "DEFAULT_CA_PATH" | "MAX_CONCURRENT_TASKS" | "SERVICE_HOST" | "SERVICE_PORT" | "SERVICE_API" | "GET_JOB_PATH" | "POST_RESULT_PATH" | "GET_JOB_URI" | "POST_RESULT_URI" | "POST_SCHEMA_URI" | "CLIENT_ID" | "CLIENT_SECRET" | "SOURCE_CREDENTIALS" | "SOURCE_CONFIGURATIONS_PATH" | "BUILD2_TOKEN" | "RESOURCE_ALIAS_MAP";
...
*/
export type ContainerState = ContainerState_waiting | ContainerState_running | ContainerState_terminated | ContainerState_notfound;
/**
...
export type ContainerStatusReason = "CRASH_LOOP_BACKOFF" | "IMAGE_PULL_BACKOFF" | "NOT_KNOWN";
export type ContainerStatusState = "WAITING" | "RUNNING" | "TERMINATED" | "NOT_FOUND" | "NOT_KNOWN";
...
export type CreateBlockVersionError = CreateBlockVersionError_deployedAppMissingDeploymentSpec;
...
export type DataType = DataType_primitiveType | DataType_complexType | DataType_unknownType;
...
export type DeployedAppMarketplaceBlockData = DeployedAppMarketplaceBlockData_deployedAppMarketplaceBlockDataV1;
...
export type DeployedAppRunStatus = DeployedAppRunStatus_containerModuleGroupStatusInfo | DeployedAppRunStatus_deploymentStatus;
...
export type DeployedAppsComputationParams = DeployedAppsComputationParams_computationParamsV1;
...
export type DeployedAppsRuntimeParams = DeployedAppsRuntimeParams_runtimeParamsV1 | DeployedAppsRuntimeParams_deploymentBasedRuntimeParamsV1;
...
*/
export type FoundryService = "ACTIONS" | "API_GATEWAY" | "ARTIFACTS" | "BELLASO" | "CATALOG" | "CI_PROXY" | "CODE" | "CODEX_HUB" | "COMPASS" | "COMPASS_BLOBSTER" | "CONDA_REPOSITORY_PROXY" | "CONDA_REPOSITORY_PROXY_AUTHZ" | "CONDA_REPOSITORY_PROXY_AUTHZ_PUBLIC" | "CONDA_REPOSITORY_PROXY_PUBLIC" | "CONDA_SERVICE" | "CONTOUR_DISPATCH" | "CONTROL_PANEL" | "CORDITE" | "DATA_HEALTH" | "EDDIE" | "EDDIE_LOGIC_EXECUTOR" | "EDDIE_PLANNER" | "EDITS" | "EGRESS_PROXY" | "FLINK_CLUSTER_MANAGER" | "FOUNDRY_CONTAINER_SERVICE" | "FOUNDRY_DATA_PROXY" | "FOUNDRY_ICEBERG" | "FOUNDRY_ICEBERG_API" | "FOUNDRY_METADATA" | "FOUNDRY_MIO" | "FOUNDRY_ML" | "FOUNDRY_ML_LIVE" | "FOUNDRY_OQL" | "FOUNDRY_RECORDS" | "FOUNDRY_REPORT" | "FOUNDRY_SQL_SERVER" | "FOUNDRY_TELEMETRY_SERVICE" | "FUNCTION_EXECUTOR" | "FUNCTION_REGISTRY" | "FUSION" | "GUARDIAN" | "JEMMA" | "JIGSAW" | "KAFKA" | "LANGUAGE_MODEL_SERVICE" | "LOG_RECEIVER" | "MAGRITTE_COORDINATOR" | "MAVEN_REPOSITORY_PROXY" | "MAVEN_REPOSITORY_PROXY_AUTHZ" | "MODELS_SERVICE" | "MULTIPASS" | "NOTEPAD" | "NOTIFICATIONS" | "OBJECT_SET_SERVICE" | "OBJECTS_DATA_FUNNEL" | "ONTOLOGY_METADATA" | "OPUS_SERVER" | "ON_PREM_PROXY" | "PRUNING" | "REPOSITORY_BOOTSTRAPPER" | "RESOURCE_POLICY_MANAGER" | "ROSETTA" | "RUBIX_EGRESS_CONNECT_PROXY" | "S3_PROXY" | "SHRINKWRAP_SERVICE" | "SPARK_CONFIGURATION_SERVICE" | "STEMMA" | "STEMMA_GIT" | "STEMMA_PULL_REQUEST" | "STEMMA_WORK_STATE" | "STREAM_CATALOG" | "STREAM_PROXY" | "TABLES" | "THIRD_PARTY_APPLICATION_SERVICE" | "TRANSFORMS_WORKER" | "TRAX_HELM" | "TILES2" | "USER_CODE_MAVEN_REPOSITORY_PROXY" | "USER_CODE_MAVEN_REPOSITORY_PROXY_AUTHZ" | "WEBHOOKS";
...
export type JobStatus = JobStatus_queued | JobStatus_inProgress | JobStatus_succeeded | JobStatus_failed | JobStatus_canceled | JobStatus_unreachable;
/**
...
export type ModuleGroupCreationOrUpdateRequest = ModuleGroupCreationOrUpdateRequest_spark | ModuleGroupCreationOrUpdateRequest_container;
/**
...
export interface ModuleGroupRollingRestartConfigs {
	...
	sparkModuleGroupVersionConfig?: SparkModuleGroupVersionConfig | null | undefined;
...
export interface ModuleGroupScalingConfigs {
	...
	scaleDownLoadThreshold?: number | "NaN" | "Infinity" | "-Infinity" | null | undefined;
	scaleUpDelay?: HumanReadableDuration | null | undefined;
	scaleUpLoadThreshold?: number | "NaN" | "Infinity" | "-Infinity" | null | undefined;
}
...
export type ModuleStatusReason = "USER_REQUESTED_SESSION_TERMINATION" | "USER_REQUESTED_APPLICATION_TERMINATION" | "EXPIRED_TTL" | "EXPIRED_LIFESPAN" | "EXPIRED_LIFESPAN_IN_PENDING" | "EXPIRED_LIFESPAN_IN_ACCEPTED" | "POD_NOT_FOUND" | "POD_NOT_RUNNING" | "POD_IN_IMAGE_PULL_BACKOFF" | "POD_IN_CRASH_LOOP_BACKOFF" | "START_FAILED_AFTER_ACCEPTANCE" | "MODULE_READY" | "MODULE_PENDING_UPDATE" | "MODULE_STARTING" | "FAILED_TO_OBTAINED_STATUS" | "DEPLOYMENT_MODULE_READY" | "DEPLOYMENT_MODULE_NOT_READY" | "NOT_KNOWN";
export type ModuleStatusStates = "STARTING" | "KILLED" | "PENDING_UPDATE" | "READY" | "NOT_KNOWN";
/**
...
*/
export type MultiplexerJobTiming = MultiplexerJobTiming_queuedJob | MultiplexerJobTiming_nonQueuedJob | MultiplexerJobTiming_noTimingPresent;
...
export type QueryRunnerSchemaParseIssue = "CANNOT_PARSE_INPUTS" | "CANNOT_PARSE_OUTPUT";
...
*/
export type QueueInfo = "NORMAL_OPERATION" | "SCALING_UP" | "SCALING_UP_FROM_0" | "RESOURCE_LIMITS_REACHED" | "COMPASS_RESOURCE_LIMITS_REACHED" | "USER_THROTTLED";
export interface Replica {
	replicaId: string;
	state: ReplicaState;
}
export type ReplicaPhase = "PENDING" | "RUNNING" | "SUCCEEDED" | "FAILED" | "NOT_KNOWN";
export type ReplicaReason = "CRASH_LOOP_BACKOFF" | "IMAGE_PULL_BACKOFF" | "REPLICA_NOT_RUNNING" | "REPLICA_NOT_FOUND" | "NOT_KNOWN";
...
export type ReplicaStateReason = "SCALING_STRATEGY" | "EXPIRED_MODULE" | "DISPOSED_BACKEND_GROUP" | "MODULE_WITH_OLD_CONFIGURATION" | "SPARK_MODULE_EXECUTOR_COUNT_TERMINATION_STRATEGY" | "MODULE_UNRESPONSIVE_TERMINATION_STRATEGY" | "MODULE_FINISHED_WORK_TERMINATION_STRATEGY" | "CONTAINER_MODULE_OUTDATED_CONFIG_TERMINATION_STRATEGY" | "FORCED_TERMINATION_BY_CONFIGURATION" | "FORCED_TERMINATION_DUE_TO_PIN_VERSION";
/**
* The status of a replica known by MGS.
*/
export type ReplicaStateValues = "STARTING" | "STARTING_ERROR" | "STARTED" | "RESPONSIVE" | "DECOMMISSIONED" | "UNRESPONSIVE" | "DELETED";
...
*/
export type ResourceProgressStatus = ResourceProgressStatus_unknownToComputeService | ResourceProgressStatus_pendingSyncToCluster | ResourceProgressStatus_applyingInCluster | ResourceProgressStatus_appliedInCluster;
export interface RollingUpdateConfig {
	maxNumberOfAdditionalReplicas?: number | null | undefined;
	maxUnavailablePercentage?: number | "NaN" | "Infinity" | "-Infinity" | null | undefined;
}
...
export type RubixNamespace = RubixNamespace_namespaceType | RubixNamespace_namespaceName;
/**
...
*/
export type UnknownToComputeService = UnknownToComputeService_deploymentId | UnknownToComputeService_applicationId;
