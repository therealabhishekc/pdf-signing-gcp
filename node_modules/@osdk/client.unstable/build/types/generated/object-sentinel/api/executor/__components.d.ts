import type { ActionTypeRid as _api_ActionTypeRid, BatchExecutionEventSummary as _api_BatchExecutionEventSummary, BatchExecutionInstance as _api_BatchExecutionInstance, BatchExecutionInstanceId as _api_BatchExecutionInstanceId, BranchRid as _api_BranchRid, EffectId as _api_EffectId, EventsToRetry as _api_EventsToRetry, ExecuteForUsers as _api_ExecuteForUsers, MonitorBatchExecution as _api_MonitorBatchExecution, MonitorEvent as _api_MonitorEvent, MonitorEventId as _api_MonitorEventId, MonitorEventSummary as _api_MonitorEventSummary, MonitorLocator as _api_MonitorLocator, MonitorRid as _api_MonitorRid, ObjectSetSource as _api_ObjectSetSource, SchedulingStrategy as _api_SchedulingStrategy, SequentialExecutionSettings as _api_SequentialExecutionSettings } from "../__components.js";
...
export interface BatchExecutionErrors {
	...
	batchSizeMustBeOneWithWebhooksOrNotifications?: BatchSizeMustBeOneWithWebhooksOrNotifications | null | undefined;
