import type { MarketplaceObjectReference as _api_MarketplaceObjectReference, MarketplaceObjectReferenceValue as _api_MarketplaceObjectReferenceValue, MarketplaceObjectRid as _api_MarketplaceObjectRid, MarketplaceObjectSetRid as _api_MarketplaceObjectSetRid, MarketplaceUserId as _api_MarketplaceUserId, ObjectPropertyTypeRid as _api_ObjectPropertyTypeRid, ObjectRid as _api_ObjectRid, ObjectSetRid as _api_ObjectSetRid, ObjectTypeRid as _api_ObjectTypeRid, UserId as _api_UserId, VersionedObjectSetRid as _api_VersionedObjectSetRid } from "../__components.js";
...
*/
export type MarketplaceValue = MarketplaceValue_boolean | MarketplaceValue_integer | MarketplaceValue_long | MarketplaceValue_double | MarketplaceValue_string | MarketplaceValue_date | MarketplaceValue_timestamp | MarketplaceValue_list | MarketplaceValue_null | MarketplaceValue_float | MarketplaceValue_objectReference | MarketplaceValue_objectRid | MarketplaceValue_objectSetRid | MarketplaceValue_versionedObjectSetRid | MarketplaceValue_attachment | MarketplaceValue_marking | MarketplaceValue_user | MarketplaceValue_mediaReference | MarketplaceValue_timeseriesReference;
...
export type NumericValue = NumericValue_integer | NumericValue_long | NumericValue_double | NumericValue_float;
/**
...
* (actions/functions/logic/notepad/...)
*/
export type Value = Value_boolean | Value_integer | Value_long | Value_double | Value_string | Value_date | Value_timestamp | Value_list | Value_null | Value_float | Value_objectReference | Value_objectRid | Value_objectSetRid | Value_versionedObjectSetRid | Value_attachment | Value_marking | Value_user | Value_mediaReference | Value_timeseriesReference;
