import type { ActionEffectInReview as _api_ActionEffectInReview, ActionEffectInReviewId as _api_ActionEffectInReviewId, BranchRid as _api_BranchRid, CronExpression as _api_CronExpression, CycleDetectionSettings as _api_CycleDetectionSettings, DatasetRid as _api_DatasetRid, DisabledConfig as _api_DisabledConfig, DisabledReason as _api_DisabledReason, EffectId as _api_EffectId, ExpiredActionEffectInReview as _api_ExpiredActionEffectInReview, ExpiryConfig as _api_ExpiryConfig, FailureEffectLog as _api_FailureEffectLog, GenericError as _api_GenericError, GlobalEffectExecutionSettings as _api_GlobalEffectExecutionSettings, LinkTypeRid as _api_LinkTypeRid, LiveConfig as _api_LiveConfig, ManagementSettings as _api_ManagementSettings, MgsConfig as _api_MgsConfig, Monitor as _api_Monitor, MonitorEvent as _api_MonitorEvent, MonitorEventId as _api_MonitorEventId, MonitorEventSetRid as _api_MonitorEventSetRid, MonitorEventWithRid as _api_MonitorEventWithRid, MonitorLocator as _api_MonitorLocator, MonitorLogic as _api_MonitorLogic, MonitorMetadataEvent as _api_MonitorMetadataEvent, MonitorRid as _api_MonitorRid, MonitorSubscriber as _api_MonitorSubscriber, MonitorValidationError as _api_MonitorValidationError, MonitorVersions as _api_MonitorVersions, MutedConfig as _api_MutedConfig, ObjectSetRid as _api_ObjectSetRid, ObjectTypeRid as _api_ObjectTypeRid, OffsetLocator as _api_OffsetLocator, ProcessedTransactionRanges as _api_ProcessedTransactionRanges, RejectStagedActionEffectLog as _api_RejectStagedActionEffectLog, RenderingConfig as _api_RenderingConfig, ReviewStatus as _api_ReviewStatus, RunningAutomationScope as _api_RunningAutomationScope, ScopedPermissionMonitorEvent as _api_ScopedPermissionMonitorEvent, ScopedSideEffects as _api_ScopedSideEffects, SkippedObjects as _api_SkippedObjects, StagedActionExecutionEffectLog as _api_StagedActionExecutionEffectLog, TelemetryConfig as _api_TelemetryConfig, TimeSeriesAlertingOverrides as _api_TimeSeriesAlertingOverrides, TransactionRange as _api_TransactionRange, TriggerExecutionSettings as _api_TriggerExecutionSettings, VersionedObjectSetRid as _api_VersionedObjectSetRid } from "../__components.js";
...
export interface BatchJobConfigOverrides {
	...
	doNotUseTransactionRangesByInput: Record<_api_DatasetRid, _api_TransactionRange>;
...
export type EventUpdate = EventUpdate_addError | EventUpdate_addErrors | EventUpdate_addSkippedObjects | EventUpdate_addProcessedTransactionRanges;
...
export type GetNextExecutionResponse = GetNextExecutionResponse_nextExecution | GetNextExecutionResponse_invalidCron;
...
export type MonitorDecoration = "LATEST_MONITOR_EVENT" | "LAST_TRIGGERED_EVENT" | "LAST_RECOVERED_EVENT";
...
export type NextExecution = NextExecution_nonDeterministic | NextExecution_scheduledAt | NextExecution_live;
...
export interface TimeseriesMonitorStatus {
	...
	streamingJobConfiguration?: StreamingTimeseriesJobConfiguration | null | undefined;
}
...
export interface UnableToMonitorLiveReasons {
	couldNotGenerateLogicalPlan?: GenericCouldNotGenerateLogicalPlanException | null | undefined;
...
export type UnsupportedFilterType = "PREFIXONLASTTOKEN" | "TERMS" | "MULTIMATCH" | "PHRASE";
...
export type UpdateTimeseriesJobConfigurationRequestV2 = UpdateTimeseriesJobConfigurationRequestV2_streaming | UpdateTimeseriesJobConfigurationRequestV2_batch;
