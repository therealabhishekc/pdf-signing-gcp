import type { MarketplaceObjectReferenceList as _api_types_MarketplaceObjectReferenceList, MarketplaceValue as _api_types_MarketplaceValue, ObjectReference as _api_types_ObjectReference, ObjectReferenceByRid as _api_types_ObjectReferenceByRid, ObjectReferenceList as _api_types_ObjectReferenceList, StringValue as _api_types_StringValue, Value as _api_types_Value } from "./types/__components.js";
...
*/
export type ActionEffectExecutionWarning = ActionEffectExecutionWarning_editsValidation;
...
export type ActionEffectLog = ActionEffectLog_success | ActionEffectLog_failure | ActionEffectLog_successMultiple | ActionEffectLog_failureMultiple | ActionEffectLog_multiple;
...
export type ActionOrLogicLocator = ActionOrLogicLocator_actionTypeRid | ActionOrLogicLocator_logicLocator;
/**
...
export type AffectedObjectsType = AffectedObjectsType_objectReferenceListType | AffectedObjectsType_objectSetRidType;
...
export type Aggregation = Aggregation_count | Aggregation_sum | Aggregation_avg | Aggregation_min | Aggregation_max;
...
export type AttachmentObjectPropertyInput = AttachmentObjectPropertyInput_previousProperty | AttachmentObjectPropertyInput_currentProperty;
...
export type AttachmentSource = AttachmentSource_notepad | AttachmentSource_notepadTemplate | AttachmentSource_staticBlobsterRid | AttachmentSource_objectProperty;
...
export type AutomationBlockCreationError = AutomationBlockCreationError_actionEffectsUnsupported | AutomationBlockCreationError_logicEffectsUnsupported | AutomationBlockCreationError_userIdInputUnsupported | AutomationBlockCreationError_versionedObjectSetsUnsupported | AutomationBlockCreationError_automationNotPublished | AutomationBlockCreationError_scopedTokenUnsupported | AutomationBlockCreationError_scopedTokenWithLanguageModelUnsupported | AutomationBlockCreationError_groupedExecutionNotSupportedForScheduled | AutomationBlockCreationError_multipleObjectTypesUsedInCondition | AutomationBlockCreationError_objectMetricsUnsupported | AutomationBlockCreationError_timeSeriesMonitorUnsupported | AutomationBlockCreationError_automationDependencyMonitorUnsupported;
...
export interface AutomationBlockDataV1 {
	...
	referencedObjectSetEntities?: MarketplaceReferencedEntities | null | undefined;
...
export type AutomationValidationError = AutomationValidationError_genericValidationError | AutomationValidationError_autoUpgradingUnsupported | AutomationValidationError_installingDisabledAutomation | AutomationValidationError_installingMutedAutomation;
...
export type BatchExecutionCancellationReason = BatchExecutionCancellationReason_userCancelled | BatchExecutionCancellationReason_tooManyFailures | BatchExecutionCancellationReason_schedulingJobFailure;
export interface BatchExecutionEventSummary {
	estimatedCompletionTime: string;
	monitorEventId: MonitorEventId;
	statuses: Record<BatchExecutionInstanceTypeEnum, BatchExecutionInstanceTypeSummary>;
}
...
export type BatchExecutionInstanceType = BatchExecutionInstanceType_queued | BatchExecutionInstanceType_submitted | BatchExecutionInstanceType_completed | BatchExecutionInstanceType_failed | BatchExecutionInstanceType_cancelled;
export type BatchExecutionInstanceTypeEnum = "QUEUED" | "SUBMITTED" | "COMPLETED" | "FAILED" | "CANCELLED";
...
export type ComparisonOperator = "EQUAL" | "NOT_EQUAL" | "LESS_THAN" | "LESS_THAN_OR_EQUAL_TO" | "GREATER_THAN" | "GREATER_THAN_OR_EQUAL_TO";
...
export type CycleDetectionSettings = CycleDetectionSettings_allowCyclesUpToLimit | CycleDetectionSettings_noCyclesAllowed;
...
export type DisabledReason = DisabledReason_userProvided | DisabledReason_cycleDetected | DisabledReason_rateLimited | DisabledReason_forceDisabledByServer;
...
export type DropEventsConfig = DropEventsConfig_failIfAnyEventsDropped | DropEventsConfig_dropEventsOverLimit;
...
export type Effect = Effect_action | Effect_notification | Effect_logic | Effect_function;
...
export type EffectDryRunExecutionValidation = EffectDryRunExecutionValidation_v1;
...
export type EffectDryRunExecutionValidationFailureHandler = EffectDryRunExecutionValidationFailureHandler_throwOnFailure | EffectDryRunExecutionValidationFailureHandler_warnOnFailure;
...
export type EffectDryRunExecutionValidatorDefinition = EffectDryRunExecutionValidatorDefinition_modifiedObjectsAreInSet;
...
export type EffectInput = EffectInput_staticValue | EffectInput_objectSetRid | EffectInput_objectReference | EffectInput_objectReferenceList | EffectInput_versionedObjectSetRid | EffectInput_affectedObject | EffectInput_affectedObjects | EffectInput_previousProperty | EffectInput_currentProperty | EffectInput_currentUser | EffectInput_relativeTimestamp | EffectInput_object | EffectInput_string | EffectInput_failureMessage | EffectInput_eventId | EffectInput_monitorRid | EffectInput_streamColumn;
export type EffectInputId = string;
export type EffectInputTypeEnum = "STATIC_VALUE" | "CURRENT_PROPERTY" | "PREVIOUS_PROPERTY" | "AFFECTED_OBJECTS" | "AFFECTED_OBJECT" | "CURRENT_USER" | "RELATIVE_TIMESTAMP" | "STREAM_COLUMN";
/**
...
export type EffectLog = EffectLog_action | EffectLog_notification | EffectLog_foundryLogic | EffectLog_function;
...
*/
export type ErrorLocation = ErrorLocation_condition | ErrorLocation_metadata | ErrorLocation_effects;
...
export type EventsToRetry = EventsToRetry_singleBatchEvent | EventsToRetry_triggerEvents | EventsToRetry_runtimeErrors;
...
export type EventType = EventType_objectSetEvent | EventType_objectEvent | EventType_metricChangeEvent | EventType_notSavedObjectSetEvent | EventType_functionGeneratedObjectSetEvent;
...
export type ExecuteForUsers = ExecuteForUsers_allUsers | ExecuteForUsers_executorUser;
...
export type ExecutionMode = ExecutionMode_perObject | ExecutionMode_perBatchOfObjects | ExecutionMode_perPartition;
export type ExecutionModeTypeEnum = "PER_OBJECT" | "PER_BATCH" | "PER_PARTITION";
...
* FoundryFieldType
*/
export type FoundryFieldType = "ARRAY" | "DECIMAL" | "MAP" | "STRUCT" | "LONG" | "BINARY" | "BOOLEAN" | "BYTE" | "DATE" | "DOUBLE" | "FLOAT" | "INTEGER" | "SHORT" | "STRING" | "TIMESTAMP";
...
export type FoundryLogicEffectLog = FoundryLogicEffectLog_stagedLogs | FoundryLogicEffectLog_acceptedLogs;
...
export type FunctionEffectLog = FunctionEffectLog_success | FunctionEffectLog_failedResultV1;
...
*/
export type JitterConfiguration = JitterConfiguration_jitterFactor | JitterConfiguration_jitterDurationMillis;
...
export type MarketplaceAggregation = MarketplaceAggregation_count | MarketplaceAggregation_sum | MarketplaceAggregation_avg | MarketplaceAggregation_min | MarketplaceAggregation_max;
...
export type MarketplaceAttachmentObjectPropertyInput = MarketplaceAttachmentObjectPropertyInput_previousProperty | MarketplaceAttachmentObjectPropertyInput_currentProperty;
...
export type MarketplaceAttachmentSource = MarketplaceAttachmentSource_notepad | MarketplaceAttachmentSource_notepadTemplate | MarketplaceAttachmentSource_staticBlobsterRid | MarketplaceAttachmentSource_objectProperty;
/**
* Condition for child automation, triggered by completion of a parent monitor.
*/
...
export interface MarketplaceCreateScenario {
	...
	actionTypeRid: MarketplaceActionTypeRid;
	effectId?: EffectId | null | undefined;
	foundryLogicExecutionIdParameter?: MarketplaceActionParameterRid | null | undefined;
...
export type MarketplaceEffect = MarketplaceEffect_action | MarketplaceEffect_notification | MarketplaceEffect_logic | MarketplaceEffect_function;
export interface MarketplaceEffectDryRunExecutionValidation_v1 {
	type: "v1";
	v1: MarketplaceEffectDryRunExecutionValidationV1;
}
export type MarketplaceEffectDryRunExecutionValidation = MarketplaceEffectDryRunExecutionValidation_v1;
...
export type MarketplaceEffectDryRunExecutionValidatorDefinition = MarketplaceEffectDryRunExecutionValidatorDefinition_modifiedObjectsAreInSet;
/**
* Settings for the execution of a specific effect.
* Overrides global execution settings if the global settings exist.
*/
...
export type MarketplaceEffectInput = MarketplaceEffectInput_staticValue | MarketplaceEffectInput_objectSetRid | MarketplaceEffectInput_objectReference | MarketplaceEffectInput_objectReferenceList | MarketplaceEffectInput_versionedObjectSetRid | MarketplaceEffectInput_affectedObject | MarketplaceEffectInput_affectedObjects | MarketplaceEffectInput_previousProperty | MarketplaceEffectInput_currentProperty | MarketplaceEffectInput_currentUser | MarketplaceEffectInput_relativeTimestamp | MarketplaceEffectInput_object | MarketplaceEffectInput_string | MarketplaceEffectInput_failureMessage | MarketplaceEffectInput_eventId | MarketplaceEffectInput_monitorRid | MarketplaceEffectInput_streamColumn;
...
export type MarketplaceEventType = MarketplaceEventType_objectSetEvent | MarketplaceEventType_objectEvent | MarketplaceEventType_metricChangeEvent | MarketplaceEventType_notSavedObjectSetEvent | MarketplaceEventType_functionGeneratedObjectSetEvent;
...
export type MarketplaceExecutionMode = MarketplaceExecutionMode_perObject | MarketplaceExecutionMode_perBatchOfObjects | MarketplaceExecutionMode_perPartition;
...
export interface MarketplaceMonitor {
	...
	versionedObjectSetsVersionsUsed: Record<VersionedObjectSetRid, MarketplaceVersionedObjectSet>;
}
...
export type MarketplaceMonitorLogic = MarketplaceMonitorLogic_event | MarketplaceMonitorLogic_scheduledEvent | MarketplaceMonitorLogic_simpleCondition | MarketplaceMonitorLogic_withRecoveryCondition | MarketplaceMonitorLogic_schedule | MarketplaceMonitorLogic_scheduledSimpleCondition | MarketplaceMonitorLogic_timeSeries | MarketplaceMonitorLogic_automationDependency | MarketplaceMonitorLogic_streamCondition;
export interface MarketplaceMonitorMetadata {
	...
	expiryDate: string;
	globalEffectExecutionSettings?: GlobalEffectExecutionSettings | null | undefined;
...
*/
export type MarketplaceMonitorSubscriberType = MarketplaceMonitorSubscriberType_user | MarketplaceMonitorSubscriberType_group;
/**
...
export type MarketplaceMultiMetricType = MarketplaceMultiMetricType_objectSetMultiMetric | MarketplaceMultiMetricType_versionedObjectSetMultiMetric;
/**
...
*/
export type MarketplaceNotepadTemplateInputsMap = Record<MarketplaceNotepadTemplateInputName, MarketplaceEffectInput>;
...
export type MarketplaceNotificationEffectRendering = MarketplaceNotificationEffectRendering_plainText | MarketplaceNotificationEffectRendering_functionRendering | MarketplaceNotificationEffectRendering_systemDefault;
...
export type MarketplaceNotificationRecipients = MarketplaceNotificationRecipients_propertyBacked | MarketplaceNotificationRecipients_functionGenerated;
...
export type MarketplaceObjectSetEventTypeV2 = MarketplaceObjectSetEventTypeV2_added | MarketplaceObjectSetEventTypeV2_removed | MarketplaceObjectSetEventTypeV2_modified | MarketplaceObjectSetEventTypeV2_allObjects;
/**
...
export type MarketplaceObjectSetFunctionInput = MarketplaceObjectSetFunctionInput_staticValue;
/**
...
*/
export type MarketplaceOperand = MarketplaceOperand_value | MarketplaceOperand_singleMetric | MarketplaceOperand_multiMetric | MarketplaceOperand_binaryOperation | MarketplaceOperand_unaryOperation;
...
export type MarketplacePredicate = MarketplacePredicate_booleanExpression | MarketplacePredicate_andPredicate | MarketplacePredicate_orPredicate | MarketplacePredicate_functionPredicate;
...
export type MarketplacePredicateFunctionInput = MarketplacePredicateFunctionInput_currentlyTriggering | MarketplacePredicateFunctionInput_staticValue | MarketplacePredicateFunctionInput_versionedObjectSetRid | MarketplacePredicateFunctionInput_objectSetRid;
...
export type MarketplacePrincipalProperty = MarketplacePrincipalProperty_userPropertyRid | MarketplacePrincipalProperty_groupPropertyRid;
...
export type MarketplacePropertiesModifiedEvent = MarketplacePropertiesModifiedEvent_anyPropertiesModified | MarketplacePropertiesModifiedEvent_exceptPropertiesModified | MarketplacePropertiesModifiedEvent_somePropertiesModified;
...
export type MarketplaceScenarioTitleInput = MarketplaceScenarioTitleInput_currentProperty;
...
*/
export type MarketplaceScopedEffect = MarketplaceScopedEffect_action | MarketplaceScopedEffect_logic;
export interface MarketplaceScopedEffectExecutor_user {
	type: "user";
	user: MarketplaceUserId;
}
export type MarketplaceScopedEffectExecutor = MarketplaceScopedEffectExecutor_user;
/**
...
export type MarketplaceSingleMetricType = MarketplaceSingleMetricType_objectSetAggregateMetric | MarketplaceSingleMetricType_versionedObjectSetAggregateMetric | MarketplaceSingleMetricType_objectMetric;
...
export type MarketplaceTimeSeriesConditionOutputInfo = MarketplaceTimeSeriesConditionOutputInfo_v1;
...
*/
export type MarketplaceTimeseriesIntermediateObjectTypeMonitorLogic = MarketplaceTimeseriesIntermediateObjectTypeMonitorLogic_event | MarketplaceTimeseriesIntermediateObjectTypeMonitorLogic_scheduledEvent;
...
*/
export type MarketplaceUrlTarget = MarketplaceUrlTarget_rid | MarketplaceUrlTarget_url;
...
export type MetadataNotificationRecipients = MetadataNotificationRecipients_allSubscribers | MetadataNotificationRecipients_managersOnly;
/**
...
export interface Monitor {
	...
	publishedMonitorVersion?: MonitorVersion | null | undefined;
	version: MonitorVersion;
	versionedObjectSetsVersionsUsed: Record<VersionedObjectSetRid, VersionedObjectSet>;
}
...
export interface MonitorEventSummary {
	effectSummaries: Record<EffectId, Record<EffectSummaryTypeEnum, EffectSummaryTypeCount>>;
	monitorEventId: MonitorEventId;
}
...
export type MonitorEventType = MonitorEventType_monitorTriggered | MonitorEventType_monitorRecovered | MonitorEventType_monitorRuntimeError | MonitorEventType_monitorBatchExecution | MonitorEventType_monitorDisabled | MonitorEventType_monitorReenabled | MonitorEventType_monitorMuted | MonitorEventType_monitorUnmuted | MonitorEventType_monitorSubscribed | MonitorEventType_monitorUnsubscribed | MonitorEventType_monitorLogicUpdated | MonitorEventType_monitorTimeseriesJob;
/**
...
export type MonitorLogic = MonitorLogic_event | MonitorLogic_scheduledEvent | MonitorLogic_simpleCondition | MonitorLogic_withRecoveryCondition | MonitorLogic_schedule | MonitorLogic_scheduledSimpleCondition | MonitorLogic_timeSeries | MonitorLogic_automationDependency | MonitorLogic_streamCondition;
...
*/
export type MonitorMetadataEventType = MonitorMetadataEventType_monitorBatchExecution | MonitorMetadataEventType_monitorDisabled | MonitorMetadataEventType_monitorReenabled | MonitorMetadataEventType_monitorMuted | MonitorMetadataEventType_monitorUnmuted | MonitorMetadataEventType_monitorSubscribed | MonitorMetadataEventType_monitorUnsubscribed | MonitorMetadataEventType_monitorLogicUpdated;
...
export type MonitorScheduleBatchExecutionStatus = MonitorScheduleBatchExecutionStatus_queued | MonitorScheduleBatchExecutionStatus_generatingRids | MonitorScheduleBatchExecutionStatus_generatingRidsFailed | MonitorScheduleBatchExecutionStatus_completed | MonitorScheduleBatchExecutionStatus_cancelling | MonitorScheduleBatchExecutionStatus_cancelled | MonitorScheduleBatchExecutionStatus_cancellingFailed;
...
* A subscriber to a monitor.
*/
export type MonitorSubscriberType = MonitorSubscriberType_user | MonitorSubscriberType_group;
...
* User scoped events
*/
export type MonitorTriggerEventType = MonitorTriggerEventType_monitorTriggered | MonitorTriggerEventType_monitorRecovered | MonitorTriggerEventType_monitorRuntimeError | MonitorTriggerEventType_monitorBatchExecution;
/**
...
*/
export type MonitorValidationErrorUnion = MonitorValidationErrorUnion_cronTooFrequent | MonitorValidationErrorUnion_invalidCron | MonitorValidationErrorUnion_invalidZoneId | MonitorValidationErrorUnion_unknownTimeseriesQuiverArtifact | MonitorValidationErrorUnion_invalidLookbackWindow | MonitorValidationErrorUnion_unauthorizedForTimeseriesScopeObjectSet | MonitorValidationErrorUnion_rootObjectTypeNotFound | MonitorValidationErrorUnion_linkedSensorObjectTypesNotFound | MonitorValidationErrorUnion_couldNotGetAllTimeseriesSyncs | MonitorValidationErrorUnion_invalidTransactionReadLimit | MonitorValidationErrorUnion_outputObjectTypeNotFound | MonitorValidationErrorUnion_noBackingDatasetForRootObjectType | MonitorValidationErrorUnion_multipleBackingDatasetsForRootObjectType | MonitorValidationErrorUnion_backingDatasetForRootObjectTypeNotInProjectScope | MonitorValidationErrorUnion_outputsNotInSingleProject | MonitorValidationErrorUnion_invalidExpiryAndLocation | MonitorValidationErrorUnion_actionOrLogicEffectAddedForNonUserSubscriber | MonitorValidationErrorUnion_allMetricIdsShouldBeUnique | MonitorValidationErrorUnion_inefficientMultiMetricUsage | MonitorValidationErrorUnion_atLeastOneMetricIsUsed | MonitorValidationErrorUnion_onlyTemporarySetsAllowed | MonitorValidationErrorUnion_actionTypeNotPermittedToRunFromAutomate | MonitorValidationErrorUnion_onlyOneEffectDependencyAllowed | MonitorValidationErrorUnion_effectDependenciesInconsistentWithEffectOrdering | MonitorValidationErrorUnion_invalidTemplateShortNotificationString | MonitorValidationErrorUnion_invalidTemplateEmailNotificationString | MonitorValidationErrorUnion_duplicateEffectInputIdsInTemplateNotification | MonitorValidationErrorUnion_templateNotificationInputsMissingParameters | MonitorValidationErrorUnion_invalidEffectInputForTemplateNotification | MonitorValidationErrorUnion_effectInputTypeMismatch | MonitorValidationErrorUnion_invalidObjectSet | MonitorValidationErrorUnion_affectedObjectProvidedForNonLiveMonitor | MonitorValidationErrorUnion_objectLocatorInputNotPermitted | MonitorValidationErrorUnion_providedPropertyRidsDoNotExistOnObjectTypes | MonitorValidationErrorUnion_actionParameterRidNotFound | MonitorValidationErrorUnion_missingRequiredActionParameter | MonitorValidationErrorUnion_unsupportedEffectInputType | MonitorValidationErrorUnion_invalidAutomation | MonitorValidationErrorUnion_invalidEffectInputForExecutionMode | MonitorValidationErrorUnion_failureInputProvidedWithoutEffectDependency | MonitorValidationErrorUnion_functionOutputTypeNotBoolean | MonitorValidationErrorUnion_functionPredicateParameterTypeDoesNotMatch | MonitorValidationErrorUnion_functionSpecsNotFound | MonitorValidationErrorUnion_scopedEffectsExecutingAsDifferentUser | MonitorValidationErrorUnion_featureNotAvailable | MonitorValidationErrorUnion_invalidUrlNotificationLink | MonitorValidationErrorUnion_invalidBatchSize | MonitorValidationErrorUnion_invalidMgsRateLimit | MonitorValidationErrorUnion_branchingUnsupportedForConditionType | MonitorValidationErrorUnion_branchingUnsupportedForVersionedObjectSets | MonitorValidationErrorUnion_functionGeneratedRecipientsNeedsScopedMode | MonitorValidationErrorUnion_functionEffectsUnsupported | MonitorValidationErrorUnion_genericError;
...
export type MonitorValidationWarning = MonitorValidationWarning_streamingSyncsIgnoredForTimeseriesMonitor | MonitorValidationWarning_scopedEffectsRunningOnGpsObjectTypes | MonitorValidationWarning_v2JobsNotEnabled;
/**
* A monitor version.
*/
...
export type MultiMetricType = MultiMetricType_objectSetMultiMetric | MultiMetricType_versionedObjectSetMultiMetric;
/**
...
export type MutedReason = MutedReason_userManuallyMuted | MutedReason_exceededFailureThreshold;
/**
...
* and are used to generate the new Notepad document.
*/
export type NotepadTemplateInputsMap = Record<NotepadTemplateInputName, EffectInput>;
...
export type NotificationEffectLog = NotificationEffectLog_success | NotificationEffectLog_failure | NotificationEffectLog_skipped | NotificationEffectLog_multiple;
...
export type NotificationEffectRendering = NotificationEffectRendering_plainText | NotificationEffectRendering_functionRendering | NotificationEffectRendering_systemDefault;
/**
...
export type NotificationRecipients = NotificationRecipients_propertyBacked | NotificationRecipients_functionGenerated;
/**
...
*/
export type ObjectChange = ObjectChange_createdObject | ObjectChange_deletedObject | ObjectChange_updatedObject | ObjectChange_streamedRecord;
...
export type ObjectSetEventType = "OBJECT_ADDED" | "OBJECT_MODIFIED" | "OBJECT_REMOVED" | "ALL_OBJECTS";
...
export type ObjectSetEventTypeV2 = ObjectSetEventTypeV2_added | ObjectSetEventTypeV2_removed | ObjectSetEventTypeV2_modified | ObjectSetEventTypeV2_allObjects;
/**
* The output of this function must be an object set.
*/
...
export type ObjectSetSource = ObjectSetSource_objectSetRid | ObjectSetSource_noObjectSetProvided | ObjectSetSource_objectSetFunction;
/**
...
* An operand can resolve to either a single value or many values bucketed in some way.
*/
export type Operand = Operand_value | Operand_singleMetric | Operand_multiMetric | Operand_binaryOperation | Operand_unaryOperation;
...
export type PotentiallyUnavailableFeature = "AIP_LOGIC" | "NOTIFICATION" | "NOTIFICATION_ATTACHMENTS" | "SCOPED_EFFECTS" | "TIMESERIES_CONDITION" | "HIGH_SCALE_AUTOMATIONS";
...
export type Predicate = Predicate_booleanExpression | Predicate_andPredicate | Predicate_orPredicate | Predicate_functionPredicate;
...
export type PredicateFunctionInput = PredicateFunctionInput_currentlyTriggering | PredicateFunctionInput_staticValue | PredicateFunctionInput_versionedObjectSetRid | PredicateFunctionInput_objectSetRid;
...
export type PrincipalProperty = PrincipalProperty_userPropertyRid | PrincipalProperty_groupPropertyRid;
/**
...
export type ProjectScopedResource = ProjectScopedResource_genericResource | ProjectScopedResource_multipleMaterializationsAvailable;
...
export type ProjectScopeIssue = ProjectScopeIssue_missingResource | ProjectScopeIssue_unsupported;
...
export type PropertiesModifiedEvent = PropertiesModifiedEvent_anyPropertiesModified | PropertiesModifiedEvent_exceptPropertiesModified | PropertiesModifiedEvent_somePropertiesModified;
...
export type RejectStagedActionEffectLog = RejectStagedActionEffectLog_success | RejectStagedActionEffectLog_failure;
/**
...
export type RetryableBatchType = "FAILED" | "COMPLETED" | "CANCELLED" | "COMPLETED_INCLUDING_SUCCESSES";
...
export type RetryableIssues = RetryableIssues_retryAllFailures | RetryableIssues_retryAllFailuresWithoutAllowlist;
...
export type RetryBackoffStrategy = RetryBackoffStrategy_exponentialBackoff | RetryBackoffStrategy_constantBackoff;
...
export type Review = Review_openReview | Review_acceptedReview | Review_rejectedReview;
...
export type SchedulingStrategy = SchedulingStrategy_scheduleImmediately | SchedulingStrategy_scheduleAtCron;
...
export type ScopedPermissionMonitorEventType = ScopedPermissionMonitorEventType_monitorTriggered | ScopedPermissionMonitorEventType_monitorRecovered | ScopedPermissionMonitorEventType_monitorRuntimeError | ScopedPermissionMonitorEventType_monitorTimeseriesJobEvent;
/**
* Used for side effects not executed on behalf of a single user, and rather executed using a scoped token.
*/
...
export type SingleMetricType = SingleMetricType_objectSetAggregateMetric | SingleMetricType_versionedObjectSetAggregateMetric | SingleMetricType_objectMetric;
/**
...
export type StagedActionExecutionEffectLog = StagedActionExecutionEffectLog_success | StagedActionExecutionEffectLog_failure | StagedActionExecutionEffectLog_noEditsGenerated | StagedActionExecutionEffectLog_failureToGenerateLogic;
...
export type StagedActionReviewEvent = StagedActionReviewEvent_actionCreated | StagedActionReviewEvent_actionUpdated | StagedActionReviewEvent_actionAccepted | StagedActionReviewEvent_actionRejected;
...
export type StagedFoundryLogicEffectLog = StagedFoundryLogicEffectLog_success | StagedFoundryLogicEffectLog_failure | StagedFoundryLogicEffectLog_noEditsGenerated;
...
*/
export type TimeSeriesEventPropertiesMapping = TimeSeriesEventPropertiesMapping_typeclassBackedPropertyMapping;
...
* The logic used for automating the intermediate object type. Note that pure schedules are not allowed, since we want to force users to only see alerts for the given automation, and therefore always need a filter on the object type.
*/
export type TimeseriesIntermediateObjectTypeMonitorLogic = TimeseriesIntermediateObjectTypeMonitorLogic_event | TimeseriesIntermediateObjectTypeMonitorLogic_scheduledEvent;
/**
...
export type TimeSeriesQuiverLocator = TimeSeriesQuiverLocator_versionedQuiverLocator | TimeSeriesQuiverLocator_unversionedQuiverLocator;
...
export type TransactionBound = TransactionBound_transactionBound | TransactionBound_noTransactionBound;
/**
...
export type TransactionReadLimit = TransactionReadLimit_monitorLimit | TransactionReadLimit_perDatasetLimit;
...
export type TriggerDependency = TriggerDependency_triggerOnFailureThreshold | TriggerDependency_triggerOnSuccess;
...
export type TriggeredBy = TriggeredBy_object | TriggeredBy_objects | TriggeredBy_offsets;
...
export type UnsupportedForScopedMode = UnsupportedForScopedMode_statefulFunctionsUnsupported | UnsupportedForScopedMode_functionGeneratedObjectSetsUnsupported | UnsupportedForScopedMode_sourcesUnsupported | UnsupportedForScopedMode_semVerValueTypesUnsupported;
/**
...
export type UserIdLocation = UserIdLocation_managers | UserIdLocation_notificationEffect;
...
export type ValueTypeVersionIdentifier = ValueTypeVersionIdentifier_uuid | ValueTypeVersionIdentifier_semver;
