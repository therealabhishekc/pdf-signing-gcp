import type { AutomationInstantEvent as _api_AutomationInstantEvent, BranchRid as _api_BranchRid, MonitorEventId as _api_MonitorEventId, MonitorLocator as _api_MonitorLocator, MonitorMetrics as _api_MonitorMetrics, MonitorRid as _api_MonitorRid, ObjectTypeRid as _api_ObjectTypeRid, ZoneId as _api_ZoneId } from "../__components.js";
...
*/
export type DependentAutomationsSearchDirectionEnum = "UPSTREAM" | "DOWNSTREAM" | "BOTH";
...
export type EvaluationInformation = EvaluationInformation_notSupportedForNonLive | EvaluationInformation_upToDate | EvaluationInformation_currentlyEvaluating | EvaluationInformation_failing | EvaluationInformation_stalled | EvaluationInformation_metricsAreNotAvailable | EvaluationInformation_currentlyIndexing;
...
export type InferredMonitorDependencySource = InferredMonitorDependencySource_liveEvaluation;
