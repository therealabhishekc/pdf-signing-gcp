import type { ActionParameterRid as _api_ActionParameterRid, ActionTypeRid as _api_ActionTypeRid, ActionTypeVersion as _api_ActionTypeVersion, AffectedObject as _api_AffectedObject, AffectedObjects as _api_AffectedObjects, ArtifactsResource as _api_ArtifactsResource, AttachmentObjectPropertyInput as _api_AttachmentObjectPropertyInput, BlobsterRid as _api_BlobsterRid, BranchRid as _api_BranchRid, ComparisonOperator as _api_ComparisonOperator, CronExpression as _api_CronExpression, CurrentUser as _api_CurrentUser, CycleDetected as _api_CycleDetected, CycleDetectionSettings as _api_CycleDetectionSettings, EffectExecutionSettings as _api_EffectExecutionSettings, EffectId as _api_EffectId, EffectInputId as _api_EffectInputId, EventsToRetry as _api_EventsToRetry, ExecuteForUsers as _api_ExecuteForUsers, ExecutionMode as _api_ExecutionMode, FailureMessage as _api_FailureMessage, ForceDisabledByServer as _api_ForceDisabledByServer, FoundryFieldSchema as _api_FoundryFieldSchema, FunctionRid as _api_FunctionRid, GlobalEffectExecutionSettings as _api_GlobalEffectExecutionSettings, IsMonitorTriggeringContextInput as _api_IsMonitorTriggeringContextInput, LanguageModelRid as _api_LanguageModelRid, LinkTypeRid as _api_LinkTypeRid, MagritteSourceResource as _api_MagritteSourceResource, MagritteSourceRid as _api_MagritteSourceRid, ManagementSettings as _api_ManagementSettings, MathBinaryOperator as _api_MathBinaryOperator, MathUnaryOperator as _api_MathUnaryOperator, MediaSetResource as _api_MediaSetResource, MetricChangeEvent as _api_MetricChangeEvent, MetricId as _api_MetricId, MgsConfig as _api_MgsConfig, MonitorLocator as _api_MonitorLocator, MonitorRid as _api_MonitorRid, MonitorSubscriberType as _api_MonitorSubscriberType, MonitorType as _api_MonitorType, MonitorVersion as _api_MonitorVersion, MultiMetric as _api_MultiMetric, MutedForUsers as _api_MutedForUsers, NoObjectSetProvided as _api_NoObjectSetProvided, NotepadAttachmentSource as _api_NotepadAttachmentSource, NotepadTemplateRid as _api_NotepadTemplateRid, NotepadTemplateVersion as _api_NotepadTemplateVersion, NotificationEffect as _api_NotificationEffect, ObjectChangedProperty as _api_ObjectChangedProperty, ObjectEvent as _api_ObjectEvent, ObjectMetric as _api_ObjectMetric, ObjectRid as _api_ObjectRid, ObjectSetAggregateMetric as _api_ObjectSetAggregateMetric, ObjectSetEventType as _api_ObjectSetEventType, ObjectSetEventTypeV2 as _api_ObjectSetEventTypeV2, ObjectSetRid as _api_ObjectSetRid, ObjectTypeRid as _api_ObjectTypeRid, PrincipalObjectProperty as _api_PrincipalObjectProperty, ScheduleDisplayMetadata as _api_ScheduleDisplayMetadata, ScheduleImmediately as _api_ScheduleImmediately, ScopedEffectExecutor as _api_ScopedEffectExecutor, SequentialExecutionSettings as _api_SequentialExecutionSettings, SingleMetric as _api_SingleMetric, StreamCondition as _api_StreamCondition, SystemDefaultRendering as _api_SystemDefaultRendering, TelemetryConfig as _api_TelemetryConfig, TimeSeriesAlertingOverrides as _api_TimeSeriesAlertingOverrides, TimeSeriesConditionOutputInfoV1 as _api_TimeSeriesConditionOutputInfoV1, TimeSeriesQuiverLocator as _api_TimeSeriesQuiverLocator, TimeSeriesStreamingConfiguration as _api_TimeSeriesStreamingConfiguration, TriggerExecutionSettings as _api_TriggerExecutionSettings, ValueTypeResource as _api_ValueTypeResource, VersionedObjectSet as _api_VersionedObjectSet, VersionedObjectSetAggregateMetric as _api_VersionedObjectSetAggregateMetric, VersionedObjectSetRid as _api_VersionedObjectSetRid, ZoneId as _api_ZoneId } from "../api/__components.js";
...
export type SafeAttachmentSource = SafeAttachmentSource_notepad | SafeAttachmentSource_notepadTemplate | SafeAttachmentSource_staticBlobsterRid | SafeAttachmentSource_objectProperty;
/**
...
export interface SafeBatchExecuteMonitorRequest {
	...
	sequentialExecutionSettings?: _api_SequentialExecutionSettings | null | undefined;
}
...
export type SafeDisabledReason = SafeDisabledReason_cycleDetected | SafeDisabledReason_forceDisabledByServer | SafeDisabledReason_rateLimited | SafeDisabledReason_userProvided;
...
export type SafeEffect = SafeEffect_action | SafeEffect_notification | SafeEffect_logic | SafeEffect_function;
...
export type SafeEffectInput = SafeEffectInput_staticValue | SafeEffectInput_objectSetRid | SafeEffectInput_objectReference | SafeEffectInput_objectReferenceList | SafeEffectInput_versionedObjectSetRid | SafeEffectInput_affectedObject | SafeEffectInput_affectedObjects | SafeEffectInput_previousProperty | SafeEffectInput_relativeTimestamp | SafeEffectInput_currentProperty | SafeEffectInput_currentUser | SafeEffectInput_object | SafeEffectInput_failureMessage | SafeEffectInput_eventId | SafeEffectInput_monitorRid | SafeEffectInput_streamColumn;
...
export type SafeEventType = SafeEventType_objectSetEvent | SafeEventType_objectEvent | SafeEventType_metricChangeEvent | SafeEventType_notSavedObjectSetEvent | SafeEventType_functionGeneratedObjectSetEvent;
...
export interface SafeMonitor {
	...
	versionedObjectSetsVersionsUsed: Record<_api_VersionedObjectSetRid, _api_VersionedObjectSet>;
}
...
export type SafeMonitorLogic = SafeMonitorLogic_event | SafeMonitorLogic_scheduledEvent | SafeMonitorLogic_simpleCondition | SafeMonitorLogic_schedule | SafeMonitorLogic_scheduledSimpleCondition | SafeMonitorLogic_withRecoveryCondition | SafeMonitorLogic_timeSeries | SafeMonitorLogic_automationDependency | SafeMonitorLogic_streamCondition;
export interface SafeMonitorMetadata {
	...
	globalEffectExecutionSettings?: _api_GlobalEffectExecutionSettings | null | undefined;
	...
	timeSeriesAlertingOverrides?: _api_TimeSeriesAlertingOverrides | null | undefined;
...
export type SafeNotificationEffectRendering = SafeNotificationEffectRendering_plainText | SafeNotificationEffectRendering_functionRendering | SafeNotificationEffectRendering_systemDefault;
...
export type SafeNotificationRecipients = SafeNotificationRecipients_propertyBacked | SafeNotificationRecipients_functionGenerated;
...
export type SafeObjectSetSource = SafeObjectSetSource_objectSetRid | SafeObjectSetSource_noObjectSetProvided | SafeObjectSetSource_objectSetFunction;
...
*/
export type SafeOperand = SafeOperand_value | SafeOperand_singleMetric | SafeOperand_multiMetric | SafeOperand_binaryOperation | SafeOperand_unaryOperation;
...
export type SafePredicate = SafePredicate_booleanExpression | SafePredicate_andPredicate | SafePredicate_orPredicate | SafePredicate_functionPredicate;
...
export type SafePredicateFunctionInput = SafePredicateFunctionInput_currentlyTriggering | SafePredicateFunctionInput_staticValue | SafePredicateFunctionInput_versionedObjectSetRid | SafePredicateFunctionInput_objectSetRid;
...
export type SafeSchedulingStrategy = SafeSchedulingStrategy_scheduleImmediately | SafeSchedulingStrategy_scheduleAtCron;
...
export type SafeTimeSeriesConditionOutputInfo = SafeTimeSeriesConditionOutputInfo_v1;
...
export type SafeTimeseriesIntermediateObjectTypeMonitorLogic = SafeTimeseriesIntermediateObjectTypeMonitorLogic_event | SafeTimeseriesIntermediateObjectTypeMonitorLogic_scheduledEvent;
