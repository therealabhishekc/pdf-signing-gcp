import type { DataType as _api_DataType, OntologyBranchRid as _api_OntologyBranchRid, OntologyRid as _api_OntologyRid, OntologyVersion as _api_OntologyVersion, PropertyTypeId as _api_PropertyTypeId, RuleSetRid as _api_RuleSetRid, ValueReferenceId as _api_ValueReferenceId } from "../__components.js";
...
export interface LoadRuleSetsRequest {
	...
	ruleSetsByBranch: Record<_api_RuleSetRid, _api_OntologyBranchRid | null | undefined>;
}
...
export type MathOperator = "EQUAL" | "NOT_EQUAL" | "GREATER_THAN" | "LESS_THAN" | "GREATER_THAN_OR_EQUAL" | "LESS_THAN_OR_EQUAL";
...
export type ValueReferenceSourceModification = ValueReferenceSourceModification_propertyTypeId;
