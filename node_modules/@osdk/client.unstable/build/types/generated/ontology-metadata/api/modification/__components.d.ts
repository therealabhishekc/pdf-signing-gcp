...
import type { EditsResolutionStrategy as _api_entitymetadata_EditsResolutionStrategy, ObjectDbType as _api_entitymetadata_ObjectDbType, ObjectDbTypeConfig as _api_entitymetadata_ObjectDbTypeConfig, ObjectTypeAlias as _api_entitymetadata_ObjectTypeAlias, PatchApplicationStrategy as _api_entitymetadata_PatchApplicationStrategy, SharedPropertyTypeAlias as _api_entitymetadata_SharedPropertyTypeAlias, StreamingConsistencyGuarantee as _api_entitymetadata_StreamingConsistencyGuarantee, StreamingProfileConfig as _api_entitymetadata_StreamingProfileConfig, TransformProfileConfig as _api_entitymetadata_TransformProfileConfig, TransitionWindows as _api_entitymetadata_TransitionWindows } from "../entitymetadata/__components.js";
...
import type { RuleChain as _api_formatting_RuleChain, RuleSet as _api_formatting_RuleSet, RuleSetBindingModification as _api_formatting_RuleSetBindingModification, RuleSetCreate as _api_formatting_RuleSetCreate, RuleSetIdentifier as _api_formatting_RuleSetIdentifier, RuleSetIdInRequest as _api_formatting_RuleSetIdInRequest, RuleSetNamedType as _api_formatting_RuleSetNamedType, ValueReferenceSourceModification as _api_formatting_ValueReferenceSourceModification } from "../formatting/__components.js";
...
import type { ResetSchemaMigrationsAndDropEditParameters as _api_schemamigrations_ResetSchemaMigrationsAndDropEditParameters, SchemaMigrationInitialization as _api_schemamigrations_SchemaMigrationInitialization, SchemaMigrationModification as _api_schemamigrations_SchemaMigrationModification } from "../schemamigrations/__components.js";
...
export interface ActionTypeModification {
	...
	parametersToCreate: Record<_api_ParameterRid, PutParameterRequestModificationWithId>;
	parametersToDelete: Array<_api_ParameterRid>;
	parametersToUpdate: Record<_api_ParameterRid, _api_EditParameterRequestModification>;
	...
	validationsToCreate: Record<_api_ValidationRuleRid, ValidationRuleModificationWithIdInRequest>;
	validationsToDelete: Array<_api_ValidationRuleRid>;
	validationsToUpdate: Record<_api_ValidationRuleRid, _api_ValidationRuleModification>;
...
*/
export type ArchiveStateModification = ArchiveStateModification_archivedState | ArchiveStateModification_pendingRestorationState;
/**
...
export interface BranchEntityIndexingConfigurationModification {
	parentBranchManyToManyLinkTypes: Record<_api_LinkTypeRid, ManyToManyLinkTypeBranchIndexingConfiguration>;
	parentBranchObjectTypes: Record<_api_ObjectTypeRid, ObjectTypeBranchIndexingConfiguration>;
}
/**
...
*/
export type CopyEditsMode = CopyEditsMode_copyEditsFromParentBranchOnInitialIndexing;
/**
...
export interface EditsResolutionStrategyModification {
	editsResolutionStrategies: Record<_api_DatasourceRid, _api_entitymetadata_EditsResolutionStrategy>;
}
export type EnabledObjectStoragesStatus = "OSV1_DISABLED" | "OSV1_DISABLED_FOR_NEW_ENTITIES" | "OSV1_ENABLED";
/**
...
export interface EntityConfigModification {
	objectDbTypeConfigs: Record<_api_entitymetadata_ObjectDbType, _api_entitymetadata_ObjectDbTypeConfig>;
}
...
export type InterfacePropertyTypeImplementationModification = InterfacePropertyTypeImplementationModification_propertyTypeId | InterfacePropertyTypeImplementationModification_structPropertyTypeMapping | InterfacePropertyTypeImplementationModification_structField | InterfacePropertyTypeImplementationModification_reducedProperty;
...
export interface ModificationHistoryPageItemSummary {
	...
	affectedManyToManyLinkTypeDatasources: Record<_api_LinkTypeRid, Record<_api_DatasourceRid, ModificationType>>;
	affectedObjectTypeDatasources: Record<_api_ObjectTypeRid, Record<_api_DatasourceRid, ModificationType>>;
	affectedObjectTypeEntityMetadatas: Record<_api_ObjectTypeRid, ModificationType>;
	affectedObjectTypes: Record<_api_ObjectTypeRid, ModificationType>;
	affectedObjectTypeSchemaMigrations: Record<_api_ObjectTypeRid, ModificationType>;
	affectedRuleSets: Record<_api_RuleSetRid, ModificationType>;
	affectedSharedPropertyTypes: Record<_api_SharedPropertyTypeRid, ModificationType>;
...
export type NestedInterfacePropertyTypeImplementationModification = NestedInterfacePropertyTypeImplementationModification_propertyTypeId | NestedInterfacePropertyTypeImplementationModification_structPropertyTypeMapping | NestedInterfacePropertyTypeImplementationModification_structField;
/**
...
export interface ObjectStorageV2Modification {
	...
	editsHistoryImportConfiguration?: EditsHistoryImportConfigurationModification | null | undefined;
	migrationConfiguration?: MigrationConfigurationModification | null | undefined;
}
...
export interface ObjectTypeDatasetDatasourceV3Modification {
	datasetRid: _api_DatasetRid;
	propertyMapping: Record<_api_PropertyTypeId, _api_PropertyTypeMappingInfo>;
	propertySecurityGroups?: _api_PropertySecurityGroupsModification | null | undefined;
}
...
export interface ObjectTypeEntityMetadataModifyRequest {
	...
	editsResolutionStrategies?: EditsResolutionStrategyModification | null | undefined;
	entityConfig?: EntityConfigModification | null | undefined;
...
export interface ObjectTypeIndexingSettingsModification {
	streamingConsistencyGuarantee?: _api_entitymetadata_StreamingConsistencyGuarantee | null | undefined;
	streamingProfileConfig?: StreamingProfileConfigModification | null | undefined;
	transformProfileConfig?: _api_entitymetadata_TransformProfileConfig | null | undefined;
}
...
export interface ObjectTypeModification {
	...
	sharedPropertyTypes: Record<_api_PropertyTypeId, PartialPropertyTypeModification>;
...
export interface ObjectTypeTraitsModification {
	...
	workflowObjectTypeTraits: Record<_api_WorkflowObjectTypeTraitId, Record<_api_WorkflowObjectTypeTraitVersion, WorkflowObjectTypeTraitImplModification>>;
}
...
export interface OneToManyLinkDefinitionModification {
	...
	oneSidePrimaryKeyToManySidePropertyMapping: Record<_api_PropertyTypeId, _api_PropertyTypeId>;
...
export interface OntologyInformationInternal {
	...
	ontologyApiNamespaceIdentifier?: OntologyApiNamespaceIdentifier | null | undefined;
	ontologyOwnersGroupId: _api_GroupId;
...
export type OntologyModificationDryRunResponse = OntologyModificationDryRunResponse_success | OntologyModificationDryRunResponse_error;
export interface OntologyModificationDryRunSuccessStatus {}
export interface OntologyModificationRequest {
	actionTypesToCreate: Record<_api_ActionTypeIdInRequest, _api_ActionTypeCreate>;
	actionTypesToDelete: Array<_api_ActionTypeRid>;
	actionTypesToUpdate: Record<_api_ActionTypeRid, _api_ActionTypeUpdate>;
	branchIndexingConfiguration?: BranchEntityIndexingConfigurationModification | null | undefined;
	...
	manyToManyLinkTypeDatasources: Record<_api_LinkTypeId, Array<ManyToManyLinkTypeDatasourceModifyRequest>>;
	objectTypeDatasources: Record<_api_ObjectTypeId, Array<ObjectTypeDatasourceModifyRequest>>;
	objectTypeEntityMetadata: Record<_api_ObjectTypeId, ObjectTypeEntityMetadataModifyRequest>;
	objectTypes: Record<_api_ObjectTypeId, ObjectTypeModifyRequest>;
	objectTypeSchemaMigrationInitializations: Record<_api_ObjectTypeId, _api_schemamigrations_SchemaMigrationInitialization>;
	objectTypeSchemaMigrations: Record<_api_ObjectTypeRid, _api_schemamigrations_SchemaMigrationModification>;
	objectTypesToResetSchemaMigrationsAndDropEdits: Record<_api_ObjectTypeRid, _api_schemamigrations_ResetSchemaMigrationsAndDropEditParameters>;
	ontologyBranchRid?: _api_OntologyBranchRid | null | undefined;
	rebasedOntologyVersion?: _api_OntologyVersion | null | undefined;
	ruleSetsToCreate: Record<_api_formatting_RuleSetIdInRequest, _api_formatting_RuleSetCreate>;
	...
	workflowsToCreate: Record<_workflow_api_WorkflowIdInRequest, _workflow_api_WorkflowCreate>;
	workflowsToDelete: Array<_workflow_api_WorkflowRid>;
	workflowsToUpdate: Record<_workflow_api_WorkflowRid, _workflow_api_WorkflowUpdate>;
}
export interface OntologyModificationResponse {
	...
	createdInterfaceTypes: Record<_api_InterfaceTypeIdInRequest, _api_InterfaceTypeRid>;
	...
	createdSharedPropertyTypes: Record<_api_SharedPropertyTypeIdInRequest, _api_SharedPropertyTypeRid>;
	createdTypeGroups: Record<_api_TypeGroupIdInRequest, _api_TypeGroupRid>;
	createdWorkflows: Record<_workflow_api_WorkflowIdInRequest, _workflow_api_WorkflowRid>;
	ontologyVersion: _api_OntologyVersion;
...
export interface OntologyUpdateRequest {
	...
	gothamMappingConfiguration?: _api_typemapping_GothamMappingConfiguration | null | undefined;
...
export interface PartialPropertyTypeModification {
	...
	propertyTypeId: _api_PropertyTypeId;
	ruleSetBinding?: _api_formatting_RuleSetBindingModification | null | undefined;
...
export interface RuleSetAndBindingsModification {
	bindings: Record<_api_ValueReferenceId, _api_formatting_ValueReferenceSourceModification>;
...
export interface SharedPropertyTypeModification {
	aliases?: Array<_api_entitymetadata_SharedPropertyTypeAlias> | null | undefined;
	apiName?: _api_ObjectTypeFieldApiName | null | undefined;
	baseFormatter?: _api_BaseFormatter | null | undefined;
	dataConstraints?: DataConstraintsModification | null | undefined;
	displayMetadata: _api_SharedPropertyTypeDisplayMetadata;
	gothamMapping?: _api_typemapping_SharedPropertyTypeGothamMappingModification | null | undefined;
	indexedForSearch: boolean;
	provenance?: EntityProvenanceModification | null | undefined;
	type: TypeForModification;
	typeClasses: Array<_api_TypeClass>;
...
*/
export type StreamingProfileConfigModification = StreamingProfileConfigModification_unset | StreamingProfileConfigModification_config;
/**
