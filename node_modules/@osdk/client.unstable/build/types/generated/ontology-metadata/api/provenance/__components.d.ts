import type { ActionTypeRid as _api_ActionTypeRid, FunctionReference as _api_FunctionReference, FunctionRid as _api_FunctionRid, GlobalBranchRid as _api_GlobalBranchRid, LinkTypeId as _api_LinkTypeId, LinkTypeIdentifier as _api_LinkTypeIdentifier, LinkTypeRid as _api_LinkTypeRid, NotepadReference as _api_NotepadReference, NotepadRid as _api_NotepadRid, ObjectTypeId as _api_ObjectTypeId, ObjectTypeRid as _api_ObjectTypeRid, PropertyTypeId as _api_PropertyTypeId, PropertyTypeRid as _api_PropertyTypeRid, QuiverDashboardReference as _api_QuiverDashboardReference, QuiverDashboardRid as _api_QuiverDashboardRid, ValueTypeReference as _api_ValueTypeReference, ValueTypeRid as _api_ValueTypeRid, WorkshopModuleRid as _api_WorkshopModuleRid, WorkshopReference as _api_WorkshopReference } from "../__components.js";
/**
...
export interface GetTaggedDependentsForOntologyEntityIdentifierRequest {
	ontologyEntityIdentifier: ProvenanceOntologyEntityIdentifier;
	pageToken?: GetTaggedDependentsForOntologyEntityIdentifierPagingToken | null | undefined;
	tag: Tag;
}
/**
...
export interface GetTaggedDependentsForOntologyEntityIdentifierResponse {
	nextPageToken?: GetTaggedDependentsForOntologyEntityIdentifierPagingToken | null | undefined;
	taggedDependencyAndDependents: Array<TaggedDependencyAndDependent>;
}
/**
...
*/
export type OmsOpsDependentType = "OBJECT_TYPE" | "FUNCTION_TYPE" | "SHARED_PROPERTY_TYPE" | "MODELING_OBJECTIVE" | "MONITOR" | "MACHINERY" | "OPUS" | "QUIVER" | "SLATE" | "WORKSHOP" | "THIRD_PARTY_APPLICATION";
...
* The resource identifier of an Ontology entity.
*/
export type ProvenanceOntologyEntityRidOrReference = ProvenanceOntologyEntityRidOrReference_propertyType | ProvenanceOntologyEntityRidOrReference_objectType | ProvenanceOntologyEntityRidOrReference_linkType | ProvenanceOntologyEntityRidOrReference_actionType | ProvenanceOntologyEntityRidOrReference_versionedValueType | ProvenanceOntologyEntityRidOrReference_versionedFunction | ProvenanceOntologyEntityRidOrReference_workshop | ProvenanceOntologyEntityRidOrReference_notepad | ProvenanceOntologyEntityRidOrReference_quiverDashboard;
/**
* Type of Ontology entity which can be a Dependency of a Dependent.
*/
export type ProvenanceOntologyEntityRidType = "PROPERTY_TYPE" | "OBJECT_TYPE" | "LINK_TYPE" | "ACTION_TYPE" | "VALUE_TYPE" | "FUNCTION" | "QUIVER" | "WORKSHOP" | "NOTEPAD";
/**
