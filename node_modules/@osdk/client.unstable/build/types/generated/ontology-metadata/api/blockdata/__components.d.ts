...
export interface KnownMarketplaceIdentifiers {
	...
	functions: Record<_api_FunctionRid, Record<_api_FunctionVersion, BlockInternalId>>;
	...
	interfacePropertyTypes: Record<_api_InterfacePropertyTypeRid, BlockInternalId>;
	...
	valueTypes: Record<_api_ValueTypeRid, Record<_api_ValueTypeVersionId, BlockInternalId>>;
...
export type MarketplaceInterfacePropertyType = MarketplaceInterfacePropertyType_sharedPropertyBasedPropertyType | MarketplaceInterfacePropertyType_interfaceDefinedPropertyType;
export interface MarketplaceInterfaceType {
	...
	propertiesV2: Record<_api_SharedPropertyTypeRid, _api_InterfaceSharedPropertyType>;
	propertiesV3: Record<_api_InterfacePropertyTypeRid, MarketplaceInterfacePropertyType>;
...
export type MarketplaceInterfaceTypeStatus = MarketplaceInterfaceTypeStatus_experimental | MarketplaceInterfaceTypeStatus_active | MarketplaceInterfaceTypeStatus_deprecated | MarketplaceInterfaceTypeStatus_example;
/**
...
export interface MarketplaceObjectTypeEntityMetadata {
	actionLogRequirednessMetadata?: _api_entitymetadata_ActionLogRequirednessMetadata | null | undefined;
...
export interface OntologyIrKnownMarketplaceIdentifiers {
	...
	interfacePropertyTypes: Record<_api_InterfacePropertyTypeApiName, BlockInternalId>;
	...
	propertyTypeIds: Record<_api_ObjectTypeApiName, Record<_api_ObjectTypeFieldApiName, BlockInternalId>>;
...
export type OntologyIrMarketplaceInterfacePropertyType = OntologyIrMarketplaceInterfacePropertyType_sharedPropertyBasedPropertyType | OntologyIrMarketplaceInterfacePropertyType_interfaceDefinedPropertyType;
export interface OntologyIrMarketplaceInterfaceType {
	...
	propertiesV3: Record<_api_InterfacePropertyTypeApiName, OntologyIrMarketplaceInterfacePropertyType>;
	searchable?: boolean | null | undefined;
...
export type OntologyIrMarketplaceInterfaceTypeStatus = OntologyIrMarketplaceInterfaceTypeStatus_experimental | OntologyIrMarketplaceInterfaceTypeStatus_active | OntologyIrMarketplaceInterfaceTypeStatus_deprecated | OntologyIrMarketplaceInterfaceTypeStatus_example;
/**
* Local overridden alias of OMS public API representation of ObjectTypeEntityMetadata. In OMS API we model
* editsResolutionStrategies field as non-optional, but Marketplace ontology block data uploaded to
* artifacts faces similar constraints as our internal StorageObjectTypeEntityMetadata and we need to provide
...
export interface OntologyIrOntologyBlockDataV2 {
	...
	sharedPropertyTypes: Record<_api_ObjectTypeFieldApiName, OntologyIrSharedPropertyTypeBlockDataV2>;
}
/**
...
export type PropertySecurityGroupPackagingVersion = PropertySecurityGroupPackagingVersion_v1 | PropertySecurityGroupPackagingVersion_v2;
/**
