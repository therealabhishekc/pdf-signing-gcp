...
export interface ActionsObjectSetModification {
	conditionValues: Record<_api_types_ConditionValueId, ConditionValueModification>;
	objectSet: DynamicObjectSet;
}
/**
...
* property value.
*/
export type ActionTypeRichTextParameterPropertyReference = ObjectParameterPropertyValue;
/**
...
export type BasePropertyType = "BOOLEAN" | "BYTE" | "DATE" | "DECIMAL" | "DOUBLE" | "FLOAT" | "GEOHASH" | "GEOSHAPE" | "INTEGER" | "LONG" | "SHORT" | "STRING" | "STRUCT" | "TIME_DEPENDENT" | "TIMESTAMP" | "ATTACHMENT" | "MARKING" | "CIPHER_TEXT" | "MEDIA_REFERENCE" | "VECTOR" | "GEOTIME_SERIES_REFERENCE";
/**
...
* The second part of a carbon workspace Url target.
*/
export type CarbonWorkspaceComponentUrlTargetModification = CarbonWorkspaceComponentUrlTargetModification_rid;
/**
...
export type Condition = Condition_true | Condition_or | Condition_and | Condition_not | Condition_comparison | Condition_markings | Condition_regex | Condition_redacted;
...
export type DatetimeLocalizedFormat = "DATE_FORMAT_RELATIVE_TO_NOW" | "DATE_FORMAT_DATE" | "DATE_FORMAT_YEAR_AND_MONTH" | "DATE_FORMAT_DATE_TIME" | "DATE_FORMAT_DATE_TIME_SHORT" | "DATE_FORMAT_TIME" | "DATE_FORMAT_ISO_INSTANT";
/**
...
export type FunctionRuleCustomExecutionMode = FunctionRuleCustomExecutionMode_bulkExecutionModeConfig;
/**
* A Function to be executed with action input parameters.
*/
...
export interface LinkTypeLoadResponse {
	...
	entityMetadata?: _api_entitymetadata_LinkTypeEntityMetadata | null | undefined;
	linkType: LinkType;
	ontologyRid: OntologyRid;
	ontologyVersion: OntologyVersion;
	resolvedBranch: ResolvedBranch;
...
* How to infer series values between adjacent data points.
*/
export type NumericInternalInterpolation = "LINEAR" | "NEAREST" | "PREVIOUS" | "NEXT" | "NONE";
/**
...
export interface ObjectTypeLoadResponse {
	...
	entityMetadata?: _api_entitymetadata_ObjectTypeEntityMetadata | null | undefined;
	objectType: ObjectType;
	ontologyRid: OntologyRid;
	ontologyVersion: OntologyVersion;
	resolvedBranch: ResolvedBranch;
...
* The second part of a carbon workspace Url target.
*/
export type OntologyIrCarbonWorkspaceComponentUrlTarget = OntologyIrCarbonWorkspaceComponentUrlTarget_rid;
/**
* A URL target for a carbon workspace.
*/
...
export type OntologyIrMultipassUserFilter = OntologyIrMultipassUserFilter_groupFilter;
...
export type OntologyIrValueReferenceSource = OntologyIrValueReferenceSource_propertyTypeRid;
/**
...
export interface ParameterDisplayMetadata {
	description: string;
	displayName: string;
	structFields: Record<_api_types_StructParameterFieldApiName, StructParameterFieldDisplayMetadata>;
...
*/
export type PropertyRenderHint = "LONG_TEXT" | "LOW_CARDINALITY" | "IDENTIFIER" | "DISABLE_FORMATTING" | "KEYWORDS" | "SORTABLE" | "SELECTABLE";
/**
* Defines a grouping of properties sharing the same security.
*
* One and exactly one of the specified groups must contain the primary key property(ies). If there
...
export type PropertyTypeIdentifier = PropertyTypeIdentifier_id | PropertyTypeIdentifier_rid;
/**
...
*/
export type RelationCardinality = "ONE_TO_MANY" | "MANY_TO_ONE" | "ONE_TO_ONE" | "MANY_TO_MANY";
...
*/
export type StructTypeElementsConstraint = Record<_api_types_StructFieldIdentifier, DataConstraints>;
/**
* An action notification's structured short body.
*/
