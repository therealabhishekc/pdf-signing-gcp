...
export type GothamDatasourceMetadata = "GOTHAM_DSR_DATASOURCE_NAME" | "GOTHAM_DSR_OBJECT_GID" | "GOTHAM_DSR_CREATED_BY" | "GOTHAM_DSR_LAST_UPDATED_BY" | "GOTHAM_DSR_CREATED_AT" | "GOTHAM_DSR_LAST_UPDATED_AT" | "GOTHAM_DSR_CUSTOM_METADATA";
...
export interface ObjectTypeGothamMapping {
	...
	objectLevelIntrinsics: Record<_api_PropertyTypeRid, GothamObjectIntrinsicMapping>;
	...
	propertyLevelDatasources: Record<_api_PropertyTypeRid, GothamPropertyDatasourceMapping>;
	propertyLevelIntrinsics: Record<_api_PropertyTypeRid, GothamPropertyIntrinsicMapping>;
	propertyLevelIntrinsicsV2: Record<_api_PropertyTypeRid, GothamPropertyIntrinsicMappingV2>;
	propertyLevelIntrinsicsV3: Record<_api_PropertyTypeRid, GothamPropertyIntrinsicMappingV3>;
...
export interface ObjectTypeGothamMappingModification {
	...
	propertyMapping: Record<_api_PropertyTypeRid, PropertyTypeGothamMappingModification>;
...
export interface OntologyIrGothamPropertyDatasourceMappingProperty {
	propertyMappings: Record<GothamDatasourceMetadata, _api_ObjectTypeFieldApiName>;
}
...
export interface OntologyIrObjectTypeGothamMapping {
	...
	objectLevelIntrinsics: Record<_api_ObjectTypeFieldApiName, GothamObjectIntrinsicMapping>;
	objectLevelIntrinsicsV2: Record<GothamIntrinsicV2, _api_ObjectTypeFieldApiName>;
	parentType: GothamOntologyParentType;
	parentTypeUri?: GothamOntologyParentTypeUri | null | undefined;
	propertyLevelDatasources: Record<_api_ObjectTypeFieldApiName, OntologyIrGothamPropertyDatasourceMapping>;
	propertyLevelIntrinsics: Record<_api_ObjectTypeFieldApiName, OntologyIrGothamPropertyIntrinsicMapping>;
	propertyLevelIntrinsicsV2: Record<_api_ObjectTypeFieldApiName, OntologyIrGothamPropertyIntrinsicMappingV2>;
	propertyLevelIntrinsicsV3: Record<_api_ObjectTypeFieldApiName, OntologyIrGothamPropertyIntrinsicMappingV3>;
	propertyMapping: Record<_api_ObjectTypeFieldApiName, PropertyTypeGothamMapping>;
	revDbIntegrationState: RevDbIntegrationState;
	uri: GothamObjectTypeUri;
}
export interface PropertyTypeGothamMapping {
	isSharedPropertyType?: boolean | null | undefined;
	structApiNameToComponentUriMapping: Record<_api_ObjectTypeFieldApiName, GothamPropertyComponentUri>;
...
export type RevDbIntegrationState = "ENABLED" | "PAUSED" | "DISABLED" | "DISABLED_ALLOW_WRITES";
