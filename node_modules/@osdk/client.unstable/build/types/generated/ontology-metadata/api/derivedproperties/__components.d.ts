import type { LinkTypeId as _api_LinkTypeId, LinkTypeRid as _api_LinkTypeRid, ObjectTypeFieldApiName as _api_ObjectTypeFieldApiName, PropertyTypeId as _api_PropertyTypeId, PropertyTypeRid as _api_PropertyTypeRid } from "../__components.js";
/**
...
export interface AggregatedPropertiesDefinitionModification {
	...
	propertyTypeMapping: Record<_api_PropertyTypeId, DerivedPropertyAggregationModification>;
}
...
export type DerivedPropertyLinkTypeIdentifier = DerivedPropertyLinkTypeIdentifier_linkType;
...
export interface LinkedPropertiesDefinitionModification {
	linkDefinition: LinkDefinitionModification;
	propertyTypeMapping: Record<_api_PropertyTypeId, PropertyTypeIdentifierInRequest>;
}
...
export interface OntologyIrAggregatedPropertiesDefinition {
	...
	propertyTypeMapping: Record<_api_ObjectTypeFieldApiName, OntologyIrDerivedPropertyAggregation>;
}
...
export type OntologyIrDerivedPropertyLinkTypeIdentifier = OntologyIrDerivedPropertyLinkTypeIdentifier_linkType;
...
export interface OntologyIrLinkedPropertiesDefinition {
	linkDefinition: OntologyIrLinkDefinition;
	propertyTypeMapping: Record<_api_ObjectTypeFieldApiName, OntologyIrPropertyTypeIdentifier>;
}
...
export type OntologyIrPropertyTypeIdentifier = OntologyIrPropertyTypeIdentifier_propertyType;
...
export interface StorageAggregatedPropertiesDefinition {
	...
	propertyTypeMapping: Record<_api_PropertyTypeRid, StorageDerivedPropertyAggregation>;
}
...
export type StorageDerivedPropertyLinkTypeIdentifier = StorageDerivedPropertyLinkTypeIdentifier_linkType;
...
export interface StorageLinkedPropertiesDefinition {
	linkDefinition: StorageLinkDefinition;
	propertyTypeMapping: Record<_api_PropertyTypeRid, StoragePropertyTypeIdentifier>;
}
...
export type StoragePropertyTypeIdentifier = StoragePropertyTypeIdentifier_propertyType;
