import type { ActionType as _api_ActionType, ActionTypeRid as _api_ActionTypeRid, DataType as _api_DataType, FunctionRid as _api_FunctionRid, InterfaceType as _api_InterfaceType, InterfaceTypeRid as _api_InterfaceTypeRid, LinkTypeRid as _api_LinkTypeRid, ObjectType as _api_ObjectType, ObjectTypeRid as _api_ObjectTypeRid, OntologyBranchRid as _api_OntologyBranchRid, OntologyRid as _api_OntologyRid, OntologyVersion as _api_OntologyVersion, PropertyTypeRid as _api_PropertyTypeRid, SharedPropertyType as _api_SharedPropertyType, SharedPropertyTypeRid as _api_SharedPropertyTypeRid, TypeGroupRid as _api_TypeGroupRid, Visibility as _api_Visibility, WebhookRid as _api_WebhookRid } from "../__components.js";
...
*/
export type ActionTypePermissionModelFilter = "DATASOURCE_DERIVED_PERMISSIONS" | "ONTOLOGY_ROLES";
/**
...
*/
export type ActionTypeStatusFilter = "EXPERIMENTAL" | "ACTIVE" | "DEPRECATED" | "EXAMPLE";
export type CombinedEntityTypeInclude = "INCLUDE_OBJECT_TYPES" | "INCLUDE_INTERFACE_TYPES";
...
*/
export type CombinedEntityTypeRid = CombinedEntityTypeRid_objectTypeRid | CombinedEntityTypeRid_interfaceTypeRid;
/**
...
*/
export type CombinedEntityTypeStatusFilter = "EXPERIMENTAL" | "ACTIVE" | "DEPRECATED" | "EXAMPLE" | "ENDORSED";
...
*/
export type CombinedEntityTypeTitleClause = CombinedEntityTypeTitleClause_and | CombinedEntityTypeTitleClause_or | CombinedEntityTypeTitleClause_title | CombinedEntityTypeTitleClause_objectTypeVisibility | CombinedEntityTypeTitleClause_interfaceTypeSupportsObjectSetSearch | CombinedEntityTypeTitleClause_status;
...
*/
export type InterfaceTypeSortBy = "INTERFACE_TYPE_DISPLAY_NAME" | "INTERFACE_TYPE_EXTENDS_INTERFACES_COUNT" | "INTERFACE_TYPE_EXTENDS_INTERFACES_AND_ANCESTORS_COUNT" | "INTERFACE_TYPE_IMPLEMENTATION_COUNT";
/**
...
*/
export type InterfaceTypeStatusFilter = "EXPERIMENTAL" | "ACTIVE" | "DEPRECATED" | "EXAMPLE";
/**
* Filter by LinkType cardinality hint
*/
export type LinkTypeCardinalityHintFilter = "ONE_TO_MANY" | "ONE_TO_ONE" | "MANY_TO_MANY";
...
*/
export type LinkTypeClause = LinkTypeClause_and | LinkTypeClause_or | LinkTypeClause_linkTypeRid | LinkTypeClause_linkTypeId | LinkTypeClause_description | LinkTypeClause_definitionType | LinkTypeClause_cardinalityHint | LinkTypeClause_linkTypeSidesTypeClass | LinkTypeClause_foreignKeyPropertyTypeRid | LinkTypeClause_primaryKeyPropertyTypeRid | LinkTypeClause_intermediaryLinkTypeRid | LinkTypeClause_objectTypeRid | LinkTypeClause_linkTypeSideADisplayName | LinkTypeClause_linkTypeSideBDisplayName | LinkTypeClause_linkTypeSideAApiName | LinkTypeClause_linkTypeSideBApiName | LinkTypeClause_linkTypeSideAVisibility | LinkTypeClause_linkTypeSideBVisibility | LinkTypeClause_entityProvenanceSource | LinkTypeClause_status | LinkTypeClause_permissionModel | LinkTypeClause_hasEditsEnabled | LinkTypeClause_targetStorageBackend;
/**
* Filter by LinkType definition type
*/
export type LinkTypeDefinitionTypeFilter = "ONE_TO_MANY" | "MANY_TO_MANY" | "INTERMEDIARY";
/**
* Filter by LinkType entity provenance
*/
export type LinkTypeEntityProvenanceFilter = "BUILDER" | "MARKETPLACE" | "OTHER";
...
* Filter by action type permission model
*/
export type LinkTypePermissionModelFilter = "DATASOURCE_DERIVED_PERMISSIONS" | "ONTOLOGY_ROLES" | "COMPASS_PROJECT";
/**
...
*/
export type LinkTypeSortBy = "LINK_TYPE_SIDE_A_DISPLAY_NAME" | "LINK_TYPE_SIDE_B_DISPLAY_NAME" | "LINK_TYPE_SIDE_A_API_NAME" | "LINK_TYPE_SIDE_B_API_NAME";
/**
...
*/
export type LinkTypeStatusFilter = "EXPERIMENTAL" | "ACTIVE" | "DEPRECATED" | "EXAMPLE";
/**
* Filter by LinkType target storage backend
*/
export type LinkTypeTargetStorageBackendFilter = "OBJECT_STORAGE_V1" | "OBJECT_STORAGE_V2";
/**
...
*/
export type LogicRuleTypeFilter = "ADD_OBJECT" | "MODIFY_OBJECT" | "DELETE_OBJECT" | "ADD_LINK" | "DELETE_LINK" | "FUNCTION" | "BATCHED_FUNCTION" | "ADD_OR_MODIFY_OBJECT" | "ADD_OR_MODIFY_OBJECT_V2";
...
*/
export type ObjectTypeClause = ObjectTypeClause_and | ObjectTypeClause_or | ObjectTypeClause_propertyTypeTypeClasses | ObjectTypeClause_propertyTypeType | ObjectTypeClause_hasEventMetadata | ObjectTypeClause_hasEditsEnabled | ObjectTypeClause_hasTimeSeriesMetadata | ObjectTypeClause_propertyTypeRid | ObjectTypeClause_propertyTypeId | ObjectTypeClause_propertyTypeApiName | ObjectTypeClause_propertyTypeDescription | ObjectTypeClause_propertyTypeDisplayName | ObjectTypeClause_propertyTypeAlias | ObjectTypeClause_objectTypeRid | ObjectTypeClause_objectTypeId | ObjectTypeClause_objectTypeDisplayName | ObjectTypeClause_objectTypeAlias | ObjectTypeClause_objectTypePluralDisplayName | ObjectTypeClause_objectTypeDescription | ObjectTypeClause_visibility | ObjectTypeClause_status | ObjectTypeClause_objectTypeExternalMapping | ObjectTypeClause_targetStorageBackend | ObjectTypeClause_objectDbType | ObjectTypeClause_entityProvenanceSource | ObjectTypeClause_permissionModel | ObjectTypeClause_objectTypeTypeGroupRids | ObjectTypeClause_objectTypeApiName;
/**
* Filter by object type entity provenance source
*/
export type ObjectTypeEntityProvenanceSourceFilter = "BUILDER" | "MARKETPLACE" | "OTHER";
/**
* Filter by external mapping type
*/
...
*/
export type ObjectTypePermissionModelFilter = "DATASOURCE_DERIVED_PERMISSIONS" | "ONTOLOGY_ROLES";
/**
...
*/
export type ObjectTypeSortBy = "OBJECT_TYPE_ID" | "OBJECT_TYPE_API_NAME" | "OBJECT_TYPE_DISPLAY_NAME" | "OBJECT_TYPE_PLURAL_DISPLAY_NAME" | "OBJECT_TYPE_UNIQUE_USERS_COUNT";
/**
...
*/
export type ObjectTypeTargetStorageBackendFilter = "OBJECT_STORAGE_V1" | "OBJECT_STORAGE_V2";
/**
...
*/
export type SemanticSearchUnavailableReason = "SEMANTIC_SEARCH_FEATURE_NOT_SUPPORTED_IN_ENVIRONMENT" | "EMBEDDINGS_NOT_ENABLED_FOR_INDEX" | "MISSING_EMBEDDINGS_METADATA_FOR_INDEX" | "EMBEDDING_SERVICE_NOT_CONFIGURED" | "NO_PERMISSION_TO_USE_EMBEDDING_MODEL" | "NO_PERMISSION_TO_SEARCH_INDEX";
...
*/
export type SharedPropertyTypeClause = SharedPropertyTypeClause_and | SharedPropertyTypeClause_or | SharedPropertyTypeClause_sharedPropertyTypeRid | SharedPropertyTypeClause_apiName | SharedPropertyTypeClause_displayName | SharedPropertyTypeClause_alias | SharedPropertyTypeClause_description | SharedPropertyTypeClause_visibility | SharedPropertyTypeClause_isIndexedForSearch | SharedPropertyTypeClause_propertyType | SharedPropertyTypeClause_typeClasses | SharedPropertyTypeClause_externalMapping;
/**
* Filter by external mapping type
*/
...
* InterfaceType features.
*/
export type TypeGroupClause = TypeGroupClause_and | TypeGroupClause_or | TypeGroupClause_displayName | TypeGroupClause_description | TypeGroupClause_typeGroupRid;
...
*/
export type TypeGroupSortBy = "TYPE_GROUP_DISPLAY_NAME" | "OBJECT_TYPE_COUNT" | "MODIFIED_AT";
/**
