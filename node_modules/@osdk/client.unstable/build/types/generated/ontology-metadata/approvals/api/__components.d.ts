import type { OntologyBranchRid as _api_OntologyBranchRid, OntologyVersion as _api_OntologyVersion, UserId as _api_UserId } from "../../api/__components.js";
import type { OntologyBranchAttribution as _branch_api_OntologyBranchAttribution, OntologyBranchDescription as _branch_api_OntologyBranchDescription, OntologyBranchDisplayName as _branch_api_OntologyBranchDisplayName, OntologyBranchModificationData as _branch_api_OntologyBranchModificationData } from "../../branch/api/__components.js";
/**
...
export interface LoadAllOntologyBranchesWithProposalPageRequest {
	filters?: LoadAllOntologyBranchesWithProposalRequestFilters | null | undefined;
	limit: number;
