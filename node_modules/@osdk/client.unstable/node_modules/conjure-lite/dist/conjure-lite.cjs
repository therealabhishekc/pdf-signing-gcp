...
const ansi = new RegExp(
  "\x1b(?:\\[(?:\\d+[ABCDEFGJKSTm]|\\d+;\\d+[Hfm]|"
    + "\\d+;\\d+;\\d+m|6n|s|u|\\?25[lh])|\\w)",
  "g",
);
  ...
  parse(argsInput, options) {
    ...
    for (let i = 0; i < args.length; i++) {
      ...
      if (arg !== "--" && /^-/.test(arg) && isUnknownOptionAsArg(arg)) {
        ...
        arg.match(/^--.+=/) || (!configuration["short-option-groups"] && arg.match(/^-.+=/))
      ) {
    ...
    function eatNargs(i, key, args, argAfterEqualSign) {
      ...
      if (configuration["nargs-eats-options"]) {
        ...
        for (ii = i + 1; ii < args.length; ii++) {
          if (
            !args[ii].match(/^-[^0-9]/) || args[ii].match(negative)
    ...
    function eatArray(i, key, args, argAfterEqualSign) {
      ...
      if (checkAllAliases(key, flags.bools) && !(/^(true|false)$/.test(next))) {
        ...
        isUndefined(next)
        || (isUndefined(argAfterEqualSign) && /^-/.test(next) && !negative.test(next)
      ...
      if (
        typeof nargsCount === "number" && ((nargsCount && argsToSet.length < nargsCount)
    ...
    function processValue(key, val, shouldStripQuotes) {
      ...
      if (
        checkAllAliases(key, flags.counts) && (isUndefined(value) || typeof value === "boolean")
      ) {
        value = increment();
      }
    ...
    function maybeCoerceNumber(key, value) {
      ...
      if (
        !checkAllAliases(key, flags.strings) && !checkAllAliases(key, flags.bools)
        && !Array.isArray(value)
      ) {
    ...
    function applyEnvVars(argv, configOnly) {
      ...
      Object.keys(env).forEach(function(envVar) {
        if (prefix === "" || envVar.lastIndexOf(prefix, 0) === 0) {
          ...
          if (
            ((configOnly && flags.configs[keys.join(".")]) || !configOnly) && !hasKey(argv, keys)
          ) {
...
const minNodeVersion = (process && process.env && process.env.YARGS_MIN_NODE_VERSION)
  ...
  : 12;
const nodeVersion =
  (_b = (_a = process === null || process === void 0 ? void 0 : process.versions) === null
          || _a === void 0
        ? void 0
...
function argumentTypeError(observedType, allowedTypes, position) {
  throw new YError(
    `Invalid ${positionName[position] || "manyith"} argument. Expected ${
...
function whichModule(exported) {
  ...
  for (let i = 0, files = Object.keys(require$1.cache), mod; i < files.length; i++) {
    mod = require$1.cache[files[i]];
...
function usage(yargs, shim) {
  ...
  function maxWidth(table, theWrap, modifier) {
    ...
    table.forEach(v => {
      width = Math.max(
        shim.stringWidth(modifier ? `${modifier} ${getText(v[0])}` : getText(v[0]))
          + getIndentation(v[0]),
        width,
      );
    });
...
class Completion {
  constructor(yargs, usage, command, shim) {
    ...
    this.zshShell = (_c = ((_a = this.shim.getEnv("SHELL")) === null || _a === void 0
            ? void 0
            : _a.includes("zsh"))
            || ((_b = this.shim.getEnv("ZSH_NAME")) === null || _b === void 0
              ? void 0
              : _b.includes("zsh"))) !== null && _c !== void 0
      ? _c
      : false;
  }
  ...
  completeOptionKey(key, completions, current, negable) {
    ...
    if (this.zshShell) {
      ...
      const aliasKey =
        (_b = (_a = this === null || this === void 0 ? void 0 : this.aliases) === null
                || _a === void 0
              ? void 0
      ...
      const desc = (_d = (_c = descs[key]) !== null && _c !== void 0 ? _c : descFromAlias) !== null
          && _d !== void 0
        ? _d
        : "";
      keyWithDesc = `${key.replace(/:/g, "\\:")}:${
        desc
  ...
  self.unknownArguments = function unknownArguments(
    ...
    if (checkPositionals) {
      ...
      const maxNonOptDemanded =
        ((_a = demandedCommands._) === null || _a === void 0 ? void 0 : _a.max) || 0;
...
function applyExtends(config, cwd, mergeExtends, _shim) {
  ...
  if (Object.prototype.hasOwnProperty.call(config, "extends")) {
    ...
    if (!isPath) {
      try {
        pathToDefault = require$1.resolve(config.extends);
      } catch (_err) {
        return config;
      }
    } else {
...
var __classPrivateFieldSet = (undefined && undefined.__classPrivateFieldSet)
...
var __classPrivateFieldGet = (undefined && undefined.__classPrivateFieldGet)
...
var _YargsInstance_command,
  _YargsInstance_cwd,
  _YargsInstance_context,
  _YargsInstance_completion,
  _YargsInstance_completionCommand,
  _YargsInstance_defaultShowHiddenOpt,
  _YargsInstance_exitError,
  _YargsInstance_detectLocale,
  _YargsInstance_emittedWarnings,
  _YargsInstance_exitProcess,
  _YargsInstance_frozens,
  _YargsInstance_globalMiddleware,
  _YargsInstance_groups,
  _YargsInstance_hasOutput,
  _YargsInstance_helpOpt,
  _YargsInstance_isGlobalContext,
  _YargsInstance_logger,
  _YargsInstance_output,
  _YargsInstance_options,
  _YargsInstance_parentRequire,
  _YargsInstance_parserConfig,
  _YargsInstance_parseFn,
  _YargsInstance_parseContext,
  _YargsInstance_pkgs,
  _YargsInstance_preservedGroups,
  _YargsInstance_processArgs,
  _YargsInstance_recommendCommands,
  _YargsInstance_shim,
  _YargsInstance_strict,
  _YargsInstance_strictCommands,
  _YargsInstance_strictOptions,
  _YargsInstance_usage,
  _YargsInstance_usageConfig,
...
class YargsInstance {
  ...
  addShowHiddenOpt(opt, msg) {
    ...
    const showHiddenOpt = typeof opt === "string"
      ? opt
      : __classPrivateFieldGet(this, _YargsInstance_defaultShowHiddenOpt, "f");
  ...
  config(key = "config", msg, parseFn) {
    ...
    if (typeof key === "object" && !Array.isArray(key)) {
      ...
      __classPrivateFieldGet(this, _YargsInstance_options, "f").configObjects =
        (__classPrivateFieldGet(this, _YargsInstance_options, "f").configObjects || []).concat(key);
      return this;
    }
  ...
  commandDir(dir, opts) {
    ...
    const req = __classPrivateFieldGet(this, _YargsInstance_parentRequire, "f")
  ...
  getHelp() {
    ...
    if (!__classPrivateFieldGet(this, _YargsInstance_usage, "f").hasCachedHelpMessage()) {
      ...
      const builderResponse = __classPrivateFieldGet(this, _YargsInstance_command, "f")
  ...
  group(opts, groupName) {
    ...
    const existing = __classPrivateFieldGet(this, _YargsInstance_preservedGroups, "f")[groupName]
      || __classPrivateFieldGet(this, _YargsInstance_groups, "f")[groupName];
    if (__classPrivateFieldGet(this, _YargsInstance_preservedGroups, "f")[groupName]) {
      delete __classPrivateFieldGet(this, _YargsInstance_preservedGroups, "f")[groupName];
    }
    const seen = {};
    __classPrivateFieldGet(this, _YargsInstance_groups, "f")[groupName] = (existing || []).concat(
      opts,
    ).filter(key => {
      if (seen[key]) {
        return false;
  ...
  option(key, opt) {
    ...
    if (typeof key === "object") {
      ...
      if (
        ...
        && (key === "version"
          || (opt === null || opt === void 0 ? void 0 : opt.alias) === "version")
      ) {
        this[kEmitWarning](
          [
      ...
      const descriptions = __classPrivateFieldGet(this, _YargsInstance_usage, "f")
        .getDescriptions();
      if (
  ...
  pkgConf(key, rootPath) {
    ...
    if (obj[key] && typeof obj[key] === "object") {
      ...
      __classPrivateFieldGet(this, _YargsInstance_options, "f").configObjects =
        (__classPrivateFieldGet(this, _YargsInstance_options, "f").configObjects || []).concat(
          conf,
        );
    }
    return this;
  ...
  positional(key, opts) {
    ...
    const fullCommand = __classPrivateFieldGet(this, _YargsInstance_context, "f")
      .fullCommands[
  ...
  [kGetDollarZero]() {
    ...
    if (
      ...
      $0 = __classPrivateFieldGet(this, _YargsInstance_shim, "f")
        ...
        .replace(
          `${
            __classPrivateFieldGet(this, _YargsInstance_shim, "f").path.dirname(
              __classPrivateFieldGet(this, _YargsInstance_shim, "f").process.execPath(),
            )
          }/`,
          "",
        );
  ...
  [kPkgUp](rootPath) {
    ...
    try {
      let startDir = rootPath
        || __classPrivateFieldGet(this, _YargsInstance_shim, "f").mainFilename;
      if (
        !rootPath && __classPrivateFieldGet(this, _YargsInstance_shim, "f").path.extname(startDir)
      ) {
  ...
  [kPopulateParserHintArrayDictionary](builder, type, key, value) {
    this[kPopulateParserHintDictionary](builder, type, key, value, (type, key, value) => {
      __classPrivateFieldGet(this, _YargsInstance_options, "f")[type][key] =
        (__classPrivateFieldGet(this, _YargsInstance_options, "f")[type][key] || []).concat(value);
    });
  }
  ...
  [kRunYargsParserAndExecuteCommands](
    ...
    __classPrivateFieldGet(this, _YargsInstance_options, "f").__ =
      __classPrivateFieldGet(this, _YargsInstance_shim, "f").y18n.__;
    __classPrivateFieldGet(this, _YargsInstance_options, "f").configuration = this
      [kGetParserConfiguration]();
    ...
    Object.keys(argv).forEach(key => {
      if (key === __classPrivateFieldGet(this, _YargsInstance_helpOpt, "f") && argv[key]) {
        ...
        key === __classPrivateFieldGet(this, _YargsInstance_versionOpt, "f") && argv[key]
      ) {
        versionOptSet = true;
      }
    });
    ...
    try {
        ...
        if (handlerKeys.length) {
          ...
          for (let i = commandIndex || 0, cmd; argv._[i] !== undefined; i++) {
            ...
            if (
              ...
              const innerArgv = __classPrivateFieldGet(this, _YargsInstance_command, "f")
                .runCommand(
                  cmd,
                  this,
                  parsed,
      ...
      if (
        ...
        skipValidation = Object.keys(argv).some(key =>
          __classPrivateFieldGet(this, _YargsInstance_options, "f").skipValidation.indexOf(key) >= 0
          && argv[key] === true
        );
      }
      if (!skipValidation) {
  ...
  [kRunValidation](aliases, positionalMap, parseErrors, isDefaultCommand) {
    ...
    return (argv) => {
      ...
      if (__classPrivateFieldGet(this, _YargsInstance_strictCommands, "f")) {
        failedStrictCommands = __classPrivateFieldGet(this, _YargsInstance_validation, "f")
...
function calculateTemplatedUrlForEndpoint(endpoint) {
...
async function writeCodeFile(path, code) {
  return await fs__namespace.promises.writeFile(
    path,
    code,
    "utf-8",
  );
...
class BaseFileGenerator {
  ...
  constructor(filePath, codeGen, def) {
  ...
  ensureImportForType(type) {
    if ("package" in type) {
      ...
      const importSpecifier = "typeName" in this.def && this.def.typeName.name === type.name
        ? `${type.name} as ${
  ...
  getImportModuleSpecifier(type) {
    let importPath = path__namespace.relative(
      path__namespace.dirname(this.filePath),
  ...
  getTypeForCode(type) {
    ...
    switch (type.type) {
      ...
      case "reference": {
        ...
        if ("typeName" in this.def && this.def.typeName.name === type.reference.name) {
          return `${
...
function generatorFactory(generateFunction) {
  return (filePath, codeGen, def) => {
    return async () => {
...
function sanitize(docLine) {
  return docLine.replace("*/", "*\\/").trim();
}

const endpointCodeGenerator = generatorFactory(
  async function() {
    ...
    const queryArg = queryParams.length === 0 ? void 0 : `{ ${
      queryParams.map((a) => {
        if (a.type.type === "map") {
          throw new Error(
    ...
    const conjureFetchArgs = [
      ...
      queryArg,
      bodyArgContentType === "application/json" ? void 0 : bodyArgContentType,
      acceptContentType === "application/json" ? void 0 : acceptContentType,
    ];
    for (let i = conjureFetchArgs.length - 1; i >= 0; i--) {
      if (conjureFetchArgs[i] === void 0) {
...
function getContentType(arg) {
  return arg && (isBinary(arg) || arg.type === "optional" && isBinary(arg.optional.itemType))
...
function isQueryArgument(a) {
  return a.paramType.type === "query";
}

const enumCodeGenerator = generatorFactory(
  async function() {
...
const objectCodeGenerator = generatorFactory(
  async function() {
...
function spreadIntoTypes(type) {
  return type[type.type];
}

const packageIndexCodeGenerator = generatorFactory(
  async function() {
    const getServiceExport = ({ serviceName }) => {
    ...
    const getTypeExport = (typeName) => {
      const qualifier = this.getImportModuleSpecifier(
        this.codeGen.getFilePathForImport(typeName),
      );
      return `export type { ${typeName.name} } from "${qualifier}";`;
    };
    const services = this.codeGen.ir.services.filter(
      (s) => s.serviceName.package == this.def.packageName,
    );
    const types = this.codeGen.ir.types.map((t) => spreadIntoTypes(t).typeName).filter(
      (t) => t.package === this.def.packageName,
    );
    ...
    const source = services.map(getServiceExport).join("\n") + "\n\n"
      + types.map(getTypeExport).join("\n") + "\n\n" + childPackages.map(
        (p) => `export * as ${p} from "./${p}/index${this.codeGen.includeExtensions ? ".js" : ""}"`,
      ).join("\n");
    await this.writeFile(source);
  },
);

const serviceCodeGenerator = generatorFactory(
  async function() {
    const source = this.def.endpoints.map(
      (e) =>
...
const typeAliasCodeGenerator = generatorFactory(
  async function() {
...
const unionCodeGenerator = generatorFactory(
  async function() {
...
class CodeGen {
  ...
  constructor(ir, args) {
    ...
    for (const t of ir.types) {
      this.packages.add(t[t.type].typeName.package);
    }
    this.#commonPackageBase = findCommonPrefix(Array.from(this.packages));
  }
  async generate() {
    const codeFiles = [];
    const completedPackages = /* @__PURE__ */ new Set();
    const actuallyAddPackage = async (packageName) => {
      if (packageName.endsWith(".")) {
        return;
      }
      if (completedPackages.has(packageName)) {
        return;
      }
      const packagePath = this.getPackageDir(packageName);
      await fs__namespace.promises.mkdir(packagePath, { recursive: true });
      codeFiles.push(
        packageIndexCodeGenerator(path__namespace.join(packagePath, "index.ts"), this, {
          packageName,
        }),
      );
    ...
    for (const service of this.ir.services) {
      ...
      await fs__namespace.promises.mkdir(serviceDir, {
        recursive: true,
      });
      codeFiles.push(
  ...
  getPackageDir(fullPackage) {
    return path__namespace.join(
      this.#outDir,
      ...fullPackage.substring(this.#commonPackageBase.length).split("."),
    );
  }
  getShortPackage(fullPackage) {
    return fullPackage.substring(this.#commonPackageBase.length);
  }
  getFilePath(typeName) {
    return `${path__namespace.join(this.getPackageDir(typeName.package), `${typeName.name}.ts`)}`;
  }
  getFilePathForImport(typeName) {
    const withoutExt = typeof typeName === "string"
      ? path__namespace.join(
        path__namespace.dirname(typeName),
        path__namespace.basename(typeName, path__namespace.extname(typeName)),
      )
      : path__namespace.join(this.getPackageDir(typeName.package), `${typeName.name}`);
  ...
  getEndpointPath(service, endpoint) {
    return `${
      path__namespace.join(
...
async function handleGenerate(args) {
  const ir = JSON.parse(
    await fs__namespace.promises.readFile(args.ir, "utf-8"),
  );
