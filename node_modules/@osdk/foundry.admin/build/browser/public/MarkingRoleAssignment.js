...
//
const _list = [0, "/v2/admin/markings/{0}/roleAssignments", 2];
/**
...
const _add = [1, "/v2/admin/markings/{0}/roleAssignments/add", 1];
/**
 * @public
 *
...
const _remove = [1, "/v2/admin/markings/{0}/roleAssignments/remove", 1];
/**
 * @public
 *
 * Required Scopes: [api:admin-write]
...
//# sourceMappingURL=MarkingRoleAssignment.js.map