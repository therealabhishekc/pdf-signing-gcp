...
//
const _list = [0, "/v2/admin/enrollments/{0}/roleAssignments", 2];
/**
...
const _add = [1, "/v2/admin/enrollments/{0}/roleAssignments/add", 3];
/**
...
const _remove = [1, "/v2/admin/enrollments/{0}/roleAssignments/remove", 3];
/**
...
//# sourceMappingURL=EnrollmentRoleAssignment.js.map