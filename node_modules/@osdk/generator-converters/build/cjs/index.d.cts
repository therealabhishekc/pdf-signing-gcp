...
import { InterfaceType, ActionTypeV2, ObjectTypeFullMetadata, PropertyApiName, PropertyV2, SharedPropertyType, ResolvedInterfacePropertyType, QueryDataType, QueryTypeV2, QueryParameterV2 } from '@osdk/foundry.ontologies';
...
declare function wirePropertyV2ToSdkPropertyDefinition(input: (PropertyV2 | SharedPropertyType | ResolvedInterfacePropertyType) & {
    nullable?: boolean;
