  ...
  switch (client.token_endpoint_auth_method) {
    ...
    case "private_key_jwt": {
      ...
      const {
        key,
        kid,
        modifyAssertion: modifyAssertion2
...
function common(client, as, _signIn, oauthHttpOptions, refresh, refreshTokenMarker, scopes) {
  ...
  function makeTokenAndSaveRefresh(resp, type) {
    ...
    !(expires_in != null) ? process.env.NODE_ENV !== "production" ? invariant2__default.default(false) : invariant2__default.default(false) : void 0;
    saveLocal(client, {
      refresh_token,
      refreshTokenMarker,
  ...
  async function signOut() {
    !token ? process.env.NODE_ENV !== "production" ? invariant2__default.default(false, "not signed in") : invariant2__default.default(false) : void 0;
...
function createConfidentialOauthClient(client_id, client_secret, url, scopes = ["api:read-data", "api:write-data", "api:use-ontologies-read", "api:use-ontologies-write"], fetchFn = globalThis.fetch, ctxPath = "multipass") {
  ...
  const {
    getToken,
    makeTokenAndSaveRefresh
  } = common(client, authServer, _signIn, oauthHttpOptions, void 0, void 0, joinedScopes);
...
function processOptionsAndAssignDefaults(url, redirect_uri, useHistory, loginPage, postLoginPage, scopes, fetchFn, ctxPath) {
  ...
  if (typeof useHistory === "object") {
    !(!loginPage && !postLoginPage && !scopes && !fetchFn && !ctxPath) ? process.env.NODE_ENV !== "production" ? invariant2__default.default(false, "If useHistory is an object, other options should not be provided") : invariant2__default.default(false) : void 0;
    options = useHistory;
  } else {
    options = {
      useHistory,
  ...
  !url ? process.env.NODE_ENV !== "production" ? invariant2__default.default(false, "url is required") : invariant2__default.default(false) : void 0;
  !redirect_uri ? process.env.NODE_ENV !== "production" ? invariant2__default.default(false, "redirectUrl is required") : invariant2__default.default(false) : void 0;
  return {
