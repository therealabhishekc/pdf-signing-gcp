  ...
  return {
    ...
    fetch: async (input, init) => {
      try {
        ...
        const betterError = e instanceof PalantirApiError ? new PalantirApiError(e.message, e.errorName, e.errorCode, e.errorDescription, e.statusCode, e.errorInstanceId, e.parameters) : new Error("Captured stack trace for error: " + (e.message ?? e));
        betterError.cause = e;
        throw betterError;
      }
    },
